...
window.JEFFENT.register({
  ...
  clinical: {
    blocks: [
      ...
      },
      {
        ...
        html: "<p>3rd and 4th arch anomalies both open into the pyriform sinus and course near the thyroid, so they're lumped clinically as <strong>pyriform sinus fistulae</strong>. Almost always <strong>left-sided</strong>.</p><p>Classic presentation: recurrent left-sided neck abscess, or \"acute suppurative thyroiditis\" in a child: an otherwise rare diagnosis that should immediately raise this anomaly.</p><p>Definitive management requires identifying and obliterating the pyriform sinus tract (endoscopic cauterization or open excision), not just draining the abscess.</p>"
      },
      {
  ...
  cards: [
    ...
    { id:"congenital-hl-causes-card", tags: ["PE", "clinical"], milestones:["PC7","MK3"], ukmla:"Hearing loss", source:"Standard pediatric audiology/genetics teaching.", front:"What are the leading causes of congenital sensorineural hearing loss?",
      back:"<strong>Genetic</strong> (most common single cause: <strong>connexin 26 / GJB2</strong> mutations), <strong>congenital CMV infection</strong> (leading non-genetic/infectious cause), and <strong>syndromic</strong> causes (Usher, Waardenburg, Pendred syndromes among others). Confirming congenital CMV requires testing (saliva/urine PCR) within the <strong>first ~3 weeks of life</strong>; after that, a positive test can't distinguish congenital from postnatal infection. Symptomatic congenital CMV (including CNS involvement/SNHL) is treated with oral <strong>valganciclovir</strong> (16 mg/kg/dose BID) for 6 months in moderate-severe disease, or ~6 weeks for isolated SNHL, with weekly neutrophil monitoring for neutropenia. CMV-related SNHL is frequently delayed/progressive, so ~40% of affected infants pass the newborn screen and need ongoing audiologic surveillance." },
    ...
    { id:"waldeyers-ring-malt-card", tags: ["PE", "anatomy"], milestones:["MK1","PC7"], ukmla:"Sore throat", source:"Standard pediatric anatomy teaching.", front:"What kind of tissue is Waldeyer's ring, and what makes its antigen sampling distinctive?",
      back:"<strong>Mucosa-associated lymphoid tissue (MALT)</strong> with germinal centers, acting as first-line immune defense at the aerodigestive entrance. It samples antigen through deep epithelial crypts and, unlike lymph nodes, has <strong>no afferent lymphatics</strong>: antigen crosses the epithelium directly." },
