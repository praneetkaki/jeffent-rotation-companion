...
window.JEFFENT.register({
  ...
  cards: [
    ...
    { id:"subglottic-hemangioma-card", tags: ["PE", "clinical"], milestones:["PC7","PC6"], redFlag:true, ukmla:"Stridor", source:"Standard pediatric airway teaching on subglottic hemangioma.", front:"What should make you reconsider a diagnosis of simple laryngomalacia in favor of subglottic hemangioma?",
      back:"<strong>Worsening</strong> (rather than stable/improving) stridor over weeks, a <strong>biphasic growth pattern</strong> typical of infantile hemangiomas, and <strong>cutaneous hemangiomas elsewhere</strong> raising concern for <strong>PHACE syndrome</strong>. Needs direct airway evaluation; first-line medical treatment is <strong>propranolol</strong>. Propranolol is typically titrated to <strong>~2-3 mg/kg/day</strong> divided 2-3 times daily, continued ~6-12 months, with airway clearance rates ~96%. Give after feeds and hold when the infant is ill/not feeding (hypoglycemia risk). <strong>Screen for PHACE syndrome</strong> before high-dose therapy, since large segmental facial/PHACE hemangiomas may warrant a lower dose and cerebrovascular imaging first." },
