...
window.JEFFENT.register({
    ...
    notes: [
      {
        ...
        tagline: "Funnel-shaped, cephalad, floppy airway",
      ...
      },
      {
        ...
        tagline: "Shorter, horizontal tube: childhood otitis",
      ...
      {
        title: "The branchial (pharyngeal) apparatus: the framework",
        tagline: "Arches, clefts, pouches: framework",
        html: "<p>The branchial apparatus appears in weeks 4-7 as a series of bulges on the side of the embryonic head that build the face and neck. Learn the three-part vocabulary first, then hang every anomaly off it.</p><ul><li><strong>Arches</strong> = the bulges themselves. Each has its own cartilage, muscle, artery (aortic arch), and cranial nerve. Mesoderm + neural crest core.</li><li><strong>Clefts (grooves)</strong> = the outside (ectoderm) gaps between arches.</li><li><strong>Pouches</strong> = the inside (endoderm) gaps between arches.</li></ul><p>Memory hook: <strong>outside is a Cleft, inside is a Pouch</strong> &mdash; C for Cleft = Cutaneous/outside; P for Pouch = Pharyngeal/inside.</p><p>There are 6 arches, but arch 5 is rudimentary/absent, so clinically you learn arches 1, 2, 3, 4, and 6. Only the first cleft stays as a normal adult structure (the external auditory canal); every other cleft and pouch should obliterate by week 7. Failure to obliterate produces the anomalies covered next.</p><p>Memory hook for tissue-of-origin: a cleft anomaly is lined by ectoderm (skin/squamous), a pouch anomaly by endoderm.</p><figure class='note-fig' data-credit='Source not yet cited, added by the project owner, replace credit before sharing.'><img class='zoomable' src='assets/img/figures/branchial_cleft_cyst.png' alt='Branchial cleft cyst' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Explains second branchial cleft anomalies and the classic tract from a neck pit anterior to the SCM up to the tonsillar fossa.</figcaption></figure>"
      },
      {
        title: "Arch derivatives: cartilage, muscle & nerve",
        tagline: "Arch nerves, muscles, skeleton",
        html: "<p>Each arch is a self-contained package: its skeleton, its muscles, and its own cranial nerve all move together. The single highest-yield rule: <strong>the nerve of an arch supplies the muscles of that same arch.</strong></p><ul><li><strong>Arch 1 (mandibular)</strong> &mdash; CN <strong>V3</strong> (trigeminal). Muscles: mastication, mylohyoid, anterior belly of digastric, tensor tympani, tensor veli palatini. Skeleton: Meckel's cartilage &rarr; malleus & incus; mandible, maxilla (membranous bone).</li><li><strong>Arch 2 (hyoid)</strong> &mdash; CN <strong>VII</strong> (facial). Muscles: facial expression, stapedius, stylohyoid, posterior belly of digastric. Skeleton: Reichert's cartilage &rarr; stapes, styloid process, lesser horn + upper hyoid.</li><li><strong>Arch 3</strong> &mdash; CN <strong>IX</strong> (glossopharyngeal). Muscle: stylopharyngeus. Skeleton: greater horn + lower body of hyoid.</li><li><strong>Arch 4</strong> &mdash; CN <strong>X</strong>, superior laryngeal branch. Muscles: pharyngeal constrictors, cricothyroid, levator veli palatini. Skeleton: thyroid & most laryngeal cartilages.</li><li><strong>Arch 6</strong> &mdash; CN <strong>X</strong>, recurrent laryngeal branch. Muscles: intrinsic laryngeal muscles (except cricothyroid). Skeleton: cricoid, arytenoid, remaining laryngeal cartilages.</li></ul><p>Memory hooks: the cranial nerves of the arches run <strong>V, VII, IX, X</strong> in order (1-2-3-4/6) &mdash; trigeminal, facial, glossopharyngeal, then vagus, the same nerves in the gag/swallow arc. Arch 1 is the \"M\" arch: Mandible, Muscles of Mastication, Malleus + incus, all V3 (\"Munches\"). Arch 2 is the \"S\" arch: Stapes, Styloid, Stylohyoid, upper hyoid, muscles of expression (VII \"Smiles\").</p><p>The cricothyroid is the odd muscle out: the one intrinsic laryngeal muscle from arch 4 (superior laryngeal nerve); all the rest come from arch 6 (recurrent laryngeal nerve). This is why the RLN and the external branch of the SLN are the two nerves at risk in thyroid surgery.</p>"
      },
      {
        title: "Pouch derivatives (endoderm): glands & spaces",
        tagline: "Pouch derivatives: glands, spaces",
        html: "<p>The pouches are endodermal and become glands and spaces (thymus, parathyroids, middle ear, tonsil), contrasting with clefts (their external counterpart), which mostly disappear.</p><ul><li><strong>Pouch 1</strong> &rarr; middle ear cavity + Eustachian tube (also contributes to the tympanic membrane). Hook: \"1 = ear.\"</li><li><strong>Pouch 2</strong> &rarr; palatine tonsil (crypts/surface epithelium). Hook: \"2 = tonsil.\"</li><li><strong>Pouch 3</strong> &rarr; inferior parathyroids + thymus. Hook: \"3 dips down, travels with the thymus.\"</li><li><strong>Pouch 4</strong> &rarr; superior parathyroids (+ ultimobranchial body &rarr; C cells). Hook: \"4 stays superior.\"</li></ul><p>Highest-yield inversion trap: <strong>inferior</strong> parathyroids come from pouch <strong>3</strong>, <strong>superior</strong> parathyroids from pouch <strong>4</strong> &mdash; because pouch 3 also carries the thymus, dragging its parathyroids inferiorly past the pouch-4 pair as the thymus descends. This is also why an ectopic inferior parathyroid can end up in the mediastinum with the thymus.</p><p>Clinical tie-in: <strong>DiGeorge syndrome</strong> (22q11.2) is failure of pouches 3 and 4 &rarr; absent thymus (T-cell immunodeficiency) + absent parathyroids (hypocalcemia). Hook: \"DiGeorge = 3rd & 4th pouch = no thymus, no parathyroids.\"</p>"
      },
      {
        title: "Waldeyer's ring: the foundational picture",
        tagline: "Adenoids, tonsils: the lymphoid ring",
        html: "<p>A ring of mucosa-associated lymphoid tissue (MALT) encircling the opening of the oral and nasal cavities into the pharynx, first described by Wilhelm von Waldeyer. It is the body's first-line immune \"gatekeeper\" at the crossroads of the respiratory and alimentary tracts, sampling inhaled and ingested antigens.</p><p>The four components, superior to inferior:</p><ul><li><strong>Pharyngeal tonsil (adenoids)</strong> &mdash; single, midline, in the roof/posterior wall of the nasopharynx. Not seen on routine oral exam (needs mirror/endoscopy).</li><li><strong>Tubal tonsils</strong> &mdash; paired, at the torus tubarius around each Eustachian tube opening. The component students most often forget, and the anatomic link between adenoid disease and middle-ear effusion.</li><li><strong>Palatine tonsils</strong> &mdash; paired, in the tonsillar fossa between the palatoglossal (anterior) and palatopharyngeal (posterior) arches. These are \"the tonsils\" seen on oral exam and graded on the Brodsky scale (0-4+, where 4+ = \"kissing\" tonsils).</li><li><strong>Lingual tonsil</strong> &mdash; at the base of the tongue.</li></ul><p>Memory hook, top to bottom: <strong>A-T-P-L</strong> &mdash; Adenoid (roof) &rarr; Tubal (around the tubes) &rarr; Palatine (the ones you see) &rarr; Lingual (tongue base).</p><p>Immunologically: lymphoid tissue with germinal centers activating B cells against nasally/orally encountered pathogens, sampled through deep epithelial crypts (the palatine tonsil has 10-30 branched crypts, massively expanding surface area but also trapping debris and becoming an infection reservoir). Unlike lymph nodes, tonsils have no afferent lymphatics &mdash; antigen reaches them directly across the epithelium.</p><figure class='note-fig' data-credit='Source not yet cited, added by the project owner, replace credit before sharing.'><img class='zoomable' src='assets/img/figures/waldeyer_ring.png' alt='Waldeyer ring' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Describes the ring of lymphoid tissue (adenoids, tubal tonsils, palatine tonsils, lingual tonsil) guarding the aerodigestive entrance.</figcaption></figure>"
      },
      {
        title: "The age curve: why this is a childhood problem",
        tagline: "Peaks ages 2-8, then regresses",
        html: "<p>Adenoid and tonsillar tissue is small at birth, grows through early childhood, peaks roughly between <strong>ages 2 and 8</strong> (relative to a still-small pharynx), then regresses through adolescence.</p><p>This growth-then-involution curve, layered on repeated viral/bacterial antigen exposure, is exactly why obstructive and infectious tonsil disease clusters in preschool/early-school-age children and becomes far less common in adults, in whom adenoids are usually vestigial.</p><p>Blood supply pearl (bleeding risk): the palatine tonsil is fed mainly by the <strong>tonsillar branch of the facial artery</strong>, with contributions from the ascending pharyngeal, lingual, and descending palatine arteries &mdash; all from the external carotid system.</p>"
      },
      {
        title: "The two clinical endpoints",
        tagline: "Recurrent tonsillitis vs obstruction",
        html: "<p>The same ring produces two distinct, high-yield problems depending on whether infection or bulk dominates:</p><ul><li><strong>Recurrent tonsillitis</strong> &mdash; repeated infection/inflammation of the palatine tonsils (histologically: fibrosis, reduced follicles, strong inflammatory infiltrate). Drives the recurrent-infection indication for tonsillectomy (Paradise-criteria frequency).</li><li><strong>Adenotonsillar hypertrophy &rarr; obstruction</strong> &mdash; bulk enlargement narrows the nasopharyngeal/oropharyngeal airway, producing mouth breathing, snoring, sleep-disordered breathing, and pediatric OSA (now the leading indication for T&A). Tubal/adenoid hypertrophy also obstructs the Eustachian tube &rarr; otitis media with effusion. Chronic untreated obstruction can cause the \"adenoid facies\" dentofacial changes and, if severe/prolonged, cor pulmonale.</li></ul><p>Waldeyer's ring is protective lymphoid tissue that predictably enlarges in early childhood, helpful for immunity, but when it over-enlarges or is chronically infected it becomes the anatomic root of recurrent tonsillitis, middle-ear effusion, and pediatric obstructive sleep apnea.</p>"
      }
    ],
    diagrams: [
      {
  ...
  clinical: {
    blocks: [
      {
        ...
        table: {
          ...
          rows: [
            ...
            ["First-line management", "Watchful waiting (most resolve in weeks)", "Analgesia for all; then observation vs high-dose amoxicillin (80&ndash;90 mg/kg/day) depending on age/severity. Use amoxicillin-clavulanate if amoxicillin in the prior 30 days, concurrent purulent conjunctivitis, or treatment failure at 48&ndash;72h."]
          ]
        }
      },
      {
        id: "aom-observation-criteria",
        title: "AOM: who can be watched, and what causes it",
        html: "<p><strong>Who can be observed:</strong> Always treat infants &lt;6 months.</p><ul><li>Ages <strong>6&ndash;23 months</strong>: antibiotics if bilateral, severe (T &ge;39&deg;C, moderate/severe otalgia, or otalgia &ge;48h), or otorrhea; otherwise a 48&ndash;72h observation option with shared decision-making and a rescue prescription is reasonable for mild, unilateral disease.</li><li>Ages <strong>&ge;2 years</strong>: observation is an option for non-severe disease.</li><li>Reassess and escalate to amoxicillin-clavulanate if not improving at 48&ndash;72h.</li></ul><p><strong>Common organisms:</strong> <em>Streptococcus pneumoniae</em>, non-typeable <em>Haemophilus influenzae</em>, and <em>Moraxella catarrhalis</em>.</p>"
      },
      {
      ...
      {
        id: "intracapsular-tonsillectomy",
        title: "Intracapsular (partial) vs extracapsular (total) tonsillectomy",
        html: "<p>For an <strong>obstructive indication</strong> (sleep-disordered breathing/OSA), <strong>intracapsular tonsillectomy (tonsillotomy)</strong> &mdash; removing the tonsil tissue while preserving the surrounding capsule as a biologic dressing over the pharyngeal muscle &mdash; is increasingly preferred. It gives comparable polysomnographic and quality-of-life improvement to total tonsillectomy, with less pain, faster return to normal diet, and substantially <strong>lower post-tonsillectomy hemorrhage</strong> (roughly 1.7% vs 4.1% in large cohorts, with a much lower return-to-OR rate).</p><p>The trade-off is a small risk of <strong>tonsillar regrowth and symptom recurrence</strong> (~2-15% depending on follow-up), so it requires long-term surveillance.</p><p><strong>Extracapsular (total) tonsillectomy</strong> remains preferred when recurrent/chronic tonsillitis is the driving indication, since it definitively removes all tonsil tissue.</p>"
      },
      {
        id: "peds-tna-perioperative",
        title: "Perioperative T&A essentials (AAO-HNS)",
        html: "<p>Give a <strong>single intraoperative dose of IV dexamethasone</strong> (~0.5 mg/kg, max ~10-16 mg) &mdash; it halves postoperative nausea/vomiting and speeds return to a normal diet. Some centers are now adding a short postoperative oral dexamethasone course (0.5 mg/kg on postop days 2/4/6) as an analgesic adjunct that may reduce opioid prescriptions without increasing bleeding risk, though this is emerging/optional practice, not established guidance.</p><p><strong>Do not give routine perioperative prophylactic antibiotics</strong> &mdash; they don't reduce infection, pain, or bleeding.</p><p>Manage pain with <strong>scheduled acetaminophen &plusmn; ibuprofen</strong> (ibuprofen does not meaningfully increase bleeding). <strong>Do not administer or prescribe codeine</strong> (or codeine-containing medications) to children &lt;12 years after tonsillectomy &mdash; ultra-rapid CYP2D6 metabolizers can convert codeine to morphine and suffer fatal respiratory depression. Tramadol shares this CYP2D6 mechanism and is likewise avoided.</p><p><strong>Admit high-risk children</strong> (age &lt;3, severe OSA, comorbidities) for postoperative monitoring given the risk of respiratory compromise.</p>"
      },
      {
        id: "newborn-hearing-screen",
        title: "Newborn hearing screening: the 1-3-6 rule",
        html: "<p>The 1-3-6 rule, in order:</p><ol><li><strong>Screen</strong> by 1 month of age (universal newborn hearing screening, using OAE or automated ABR).</li><li><strong>Diagnose</strong> definitively by 3 months if screening fails.</li><li><strong>Begin intervention</strong> (amplification, early intervention services) by 6 months.</li></ol><p>Missing this window measurably worsens speech and language development outcomes.</p>"
      },
      {
        id: "congenital-neck-masses",
        title: "Congenital neck masses by location",
        html: "<p>Location does most of the differential work.</p><p>Thyroglossal duct cyst is the most common congenital neck mass (~70%); branchial cleft anomalies are second (~20%). Most congenital neck masses are midline (~66%).</p><figure class='note-fig' data-credit='Source not yet cited, added by the project owner, replace credit before sharing.'><img class='zoomable' src='assets/img/figures/congenital_neck_masses.png' alt='Congenital neck masses' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Uses anatomic location (midline, lateral anterior to SCM, posterior triangle, preauricular) to differentiate congenital neck mass diagnoses.</figcaption></figure>",
        table: {
      ...
      {
        id: "branchial-anomaly-rule",
        title: "The unifying rule: where each branchial anomaly opens internally",
        html: "<p>A branchial anomaly is a remnant that failed to obliterate. Whether it presents as a cyst (no opening), sinus (one opening), or fistula (opens to both skin and pharynx) depends on what persisted, but the <strong>internal opening is fixed by the arch of origin</strong>:</p><ul><li><strong>1st cleft</strong> &rarr; external auditory canal / around the pinna & parotid (near the facial nerve).</li><li><strong>2nd cleft</strong> &rarr; tonsillar fossa (the classic one).</li><li><strong>3rd & 4th</strong> &rarr; pyriform sinus (3rd = base, 4th = apex; almost always left-sided).</li></ul><p>Memory hook: count up as you go deeper and lower &mdash; 1 = ear, 2 = tonsil, 3 & 4 = pyriform sinus. The internal opening climbs down the pharynx as the arch number rises.</p><p>Second-cleft dominance: roughly <strong>90-95%</strong> of all branchial cleft anomalies are 2nd cleft &mdash; a lateral neck cyst along the anterior border of the SCM is a 2nd branchial cleft cyst until proven otherwise.</p>"
      },
      {
        id: "second-branchial-cleft-cyst",
        title: "The 2nd branchial cleft cyst: the must-know anomaly",
        html: "<p>Classic picture: a painless, smooth, fluctuant mass at the anterior border of the upper-third SCM, often first noticed or enlarging after an upper respiratory infection. Aspirate resembles \"motor oil\"/cholesterol-crystal fluid.</p><p>The tract is the high-yield anatomy: from the tonsillar fossa, it passes <strong>between the internal and external carotid arteries</strong>, superficial to CN IX and XII, and terminates at the skin anterior to the SCM. Memory hook: \"the 2nd-cleft tract splits the carotids.\"</p><p>FNA is useful and accurate for diagnosis in older children/adults, but in an adult over ~40, a \"branchial cleft cyst\" must have a <strong>cystic nodal metastasis from HPV+ oropharyngeal cancer</strong> excluded first.</p><p>Definitive treatment is complete surgical excision of the cyst and any tract; incomplete excision recurs. Drain/treat active infection before elective excision.</p>"
      },
      {
        id: "pyriform-sinus-tract",
        title: "3rd/4th anomalies: the pyriform sinus fistula pitfall",
        html: "<p>3rd and 4th arch anomalies both open into the pyriform sinus and course near the thyroid, so they're lumped clinically as <strong>pyriform sinus fistulae</strong>. Almost always <strong>left-sided</strong>.</p><p>Classic presentation: recurrent left-sided neck abscess, or \"acute suppurative thyroiditis\" in a child &mdash; an otherwise rare diagnosis that should immediately raise this anomaly.</p><p>Definitive management requires identifying and obliterating the pyriform sinus tract (endoscopic cauterization or open excision), not just draining the abscess.</p>"
      },
      {
        id: "first-branchial-cleft-anomaly",
        title: "1st cleft anomaly: the facial-nerve trap",
        html: "<p>Rare (~1% of branchial anomalies) but high-stakes: presents around the angle of the mandible/periauricular region, or as recurrent otorrhea with a normal middle ear.</p><p>The tract runs near or through the facial nerve and parotid, so excision risks CN VII injury and belongs to an experienced surgeon.</p>"
      },
      {
        id: "lateral-vs-midline-neck-masses",
        title: "Lateral vs midline neck masses: the quick contrast",
        html: "<p>Memory hook: midline + moves with the tongue = thyroglossal; lateral + anterior to SCM = branchial.</p>",
        table: {
          head: ["Mass", "Location", "Moves with tongue protrusion?", "Origin"],
          rows: [
    ...
    redFlags: [
      ...
      { t: "<b>Recurrent left-sided neck abscess or suppurative thyroiditis in a child</b>: suspect a 3rd/4th pyriform sinus fistula; image and find the tract rather than repeatedly draining." },
      { t: "<b>'Branchial cleft cyst' first appearing in an adult &gt;40</b>: exclude a cystic metastasis from HPV+ oropharyngeal carcinoma before calling it congenital." },
      { t: "<b>Recurrent otorrhea with a normal-looking middle ear &plusmn; periauricular swelling</b>: consider a 1st branchial cleft anomaly near the facial nerve." },
      { t: "<b>Neonate/infant with hypocalcemia, recurrent infections, and congenital heart disease</b>: think DiGeorge syndrome (pouch 3/4 failure)." }
    ]
  },
  ...
  cases: [
    ...
    },
    {
      ...
      teaching: "<figure class='note-fig' data-credit='Source not yet cited, added by the project owner, replace credit before sharing.'><img class='zoomable' src='assets/img/figures/congenital_neck_masses.png' alt='Congenital neck masses' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Child with a midline neck mass moving with tongue protrusion, diagnosed as thyroglossal duct cyst, requiring thyroid imaging before Sistrunk procedure.</figcaption></figure>Don't excise a midline neck cyst without imaging the thyroid first. 'It's probably just a thyroglossal cyst' still needs that one confirmatory step."
    },
    {
    ...
    },
    {
      ...
      teaching: "<figure class='note-fig' data-credit='Source not yet cited, added by the project owner, replace credit before sharing.'><img class='zoomable' src='assets/img/figures/cervical_fascia_danger_space.png' alt='Cervical fascia danger space' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Young child with fever, rigid neck extension, muffled voice, and drooling from a retropharyngeal abscess, diagnosed with contrast CT distinguishing abscess from phlegmon.</figcaption></figure>Pediatric retropharyngeal abscess presents in a child typically under 6 with fever, neck stiffness/torticollis, muffled voice, and drooling after a preceding URI; a widened prevertebral space on lateral X-ray screens for it, but contrast CT is what separates a drainable abscess from phlegmon and decides whether surgery joins IV antibiotics."
    }
  ],
  ...
  cards: [
    ...
    { id:"aom-treatment-card", tags: ["PE", "pharm"], milestones:["SBP3","PC7"], ukmla:"Painful ear", source:"AAP Clinical Practice Guideline: Diagnosis and Management of Acute Otitis Media, 2013.", front:"What determines whether a child with AOM gets watchful waiting vs immediate antibiotics?",
      back:"<strong>Immediate antibiotics</strong> for: age &lt;6 months (any AOM); otorrhea or severe symptoms (T &ge;39&deg;C, moderate-severe or &ge;48h otalgia) at any age; and children 6-23 months with <strong>bilateral</strong> AOM. <strong>Observation</strong> for 48-72h (shared decision-making, with analgesia and assured follow-up) is an option for 6-23 months with non-severe <strong>unilateral</strong> AOM, and for &ge;24 months with non-severe unilateral or bilateral AOM. First-line is <strong>high-dose amoxicillin</strong> (80-90 mg/kg/day divided BID). Use high-dose <strong>amoxicillin-clavulanate</strong> first-line instead when <em>H. influenzae</em> is likely &mdash; antibiotics in the prior 30 days, concurrent purulent conjunctivitis, or TM rupture. <strong>Duration:</strong> 10 days if &lt;2 years or severe; 7 days for ages 2-5; 5-7 days for &ge;6 years with mild-moderate disease. Avoid macrolides (pneumococcal resistance)." },
    ...
    { id:"intracapsular-tonsillectomy-card", tags: ["PE", "clinical"], milestones:["PC7","PC9"], ukmla:"Sore throat", source:"Blackshaw et al., Cochrane Database Syst Rev, 2020; Loh et al., Int J Pediatr Otorhinolaryngol, 2024.", front:"For an obstructive (OSA) indication, <span class=\"cloze-blank\">[...]</span> tonsillectomy is increasingly preferred over total tonsillectomy because it roughly halves post-tonsillectomy bleeding, at the cost of a small risk of regrowth.",
      back:"For an obstructive (OSA) indication, <mark class=\"cloze-answer\">intracapsular (partial)</mark> tonsillectomy (tonsillotomy) is increasingly preferred over total tonsillectomy because it roughly halves post-tonsillectomy bleeding (and markedly lowers return-to-OR rates), at the cost of a small risk of tonsillar regrowth/recurrence. Total (extracapsular) tonsillectomy is still preferred when recurrent/chronic tonsillitis is the indication." },
    { id:"peds-tna-perioperative-card", tags: ["PE", "pharm"], milestones:["PC7","SBP3"], ukmla:"Sore throat", source:"Mitchell et al., AAO-HNS Tonsillectomy in Children Update, Otolaryngol Head Neck Surg, 2019.", front:"In pediatric tonsillectomy, a single intraoperative dose of <span class=\"cloze-blank\">[...]</span> reduces nausea/vomiting, while routine perioperative antibiotics are not recommended and codeine is contraindicated.",
      back:"In pediatric tonsillectomy, a single intraoperative dose of <mark class=\"cloze-answer\">IV dexamethasone (~0.5 mg/kg)</mark> reduces PONV and speeds return to normal diet. Routine perioperative prophylactic antibiotics are not recommended (no benefit for infection/pain/bleeding), and codeine is contraindicated post-T&A because ultra-rapid CYP2D6 metabolizers risk fatal respiratory depression. Base analgesia on scheduled acetaminophen &plusmn; ibuprofen." },
    ...
    { id:"congenital-hl-causes-card", tags: ["PE", "clinical"], milestones:["PC7","MK3"], ukmla:"Hearing loss", source:"Standard pediatric audiology/genetics teaching.", front:"What are the leading causes of congenital sensorineural hearing loss?",
      back:"<strong>Genetic</strong> (most common single cause: <strong>connexin 26 / GJB2</strong> mutations), <strong>congenital CMV infection</strong> (leading non-genetic/infectious cause), and <strong>syndromic</strong> causes (Usher, Waardenburg, Pendred syndromes among others). Confirming congenital CMV requires testing (saliva/urine PCR) within the <strong>first ~3 weeks of life</strong>; after that, a positive test can't distinguish congenital from postnatal infection. Symptomatic congenital CMV (including CNS involvement/SNHL) is treated with oral <strong>valganciclovir</strong> (16 mg/kg/dose BID) &mdash; 6 months for moderate-severe disease, ~6 weeks for isolated SNHL &mdash; with weekly neutrophil monitoring for neutropenia. CMV-related SNHL is frequently delayed/progressive, so ~40% of affected infants pass the newborn screen and need ongoing audiologic surveillance." },
    { id:"congenital-neck-mass-card", tags: ["PE", "clinical"], milestones:["PC7","PC3"], ukmla:"Neck lump", source:"Standard pediatric otolaryngology teaching on congenital neck masses.", front:"Use location to differentiate congenital neck masses.",
      back:"<ul><li><strong>Midline</strong> → thyroglossal duct cyst (moves with tongue protrusion).</li><li><strong>Lateral, anterior to SCM</strong> → branchial cleft cyst.</li><li><strong>Posterior triangle</strong> → cystic hygroma/lymphatic malformation.</li><li><strong>Preauricular</strong> → preauricular pit/sinus.</li></ul>" },
    ...
    { id:"subglottic-hemangioma-card", tags: ["PE", "clinical"], milestones:["PC7","PC6"], redFlag:true, ukmla:"Stridor", source:"Standard pediatric airway teaching on subglottic hemangioma.", front:"What should make you reconsider a diagnosis of simple laryngomalacia in favor of subglottic hemangioma?",
      back:"<ul><li><strong>Reconsider laryngomalacia when:</strong> stridor is <strong>worsening</strong> (rather than stable/improving) over weeks, growth follows a <strong>biphasic pattern</strong> typical of infantile hemangiomas, or there are <strong>cutaneous hemangiomas elsewhere</strong> raising concern for <strong>PHACE syndrome</strong>.</li><li>Needs direct airway evaluation; first-line medical treatment is <strong>propranolol</strong>.</li><li>Propranolol is typically titrated to <strong>~2-3 mg/kg/day</strong> divided 2-3 times daily, continued ~6-12 months, with airway clearance rates ~96%. Give after feeds and hold when the infant is ill/not feeding (hypoglycemia risk).</li><li><strong>Screen for PHACE syndrome</strong> before high-dose therapy, since large segmental facial/PHACE hemangiomas may warrant a lower dose and cerebrovascular imaging first.</li></ul>" },
    ...
    { id:"branchial-cleft-vs-pouch-card", tags: ["PE", "embryo"], milestones:["MK1","PC7"], ukmla:"Neck lump", source:"Standard embryology teaching on the branchial apparatus.", front:"In the branchial apparatus, clefts are lined by [...] and become skin-side structures, while pouches are lined by [...] and become glands/spaces.",
      back:"Clefts are lined by <strong>ectoderm</strong> (only the 1st persists, as the external auditory canal); pouches are lined by <strong>endoderm</strong> (middle ear, tonsil, thymus, parathyroids). Hook: outside = Cleft/Cutaneous, inside = Pouch/Pharyngeal." },
    { id:"branchial-arch-nerves-card", tags: ["PE", "embryo"], milestones:["MK1","PC7"], ukmla:"Neck lump", source:"Standard embryology teaching on the branchial apparatus.", front:"Name the cranial nerve of branchial arches 1, 2, 3, and 4/6 in order.",
      back:"<strong>V3, VII, IX, X</strong> (arch 1 &rarr; V3, arch 2 &rarr; VII, arch 3 &rarr; IX, arch 4 & 6 &rarr; X). The nerve of each arch supplies the muscles derived from that arch." },
    { id:"branchial-arch1-vs-arch2-card", tags: ["PE", "embryo"], milestones:["MK1","PC7"], ukmla:"Neck lump", source:"Standard embryology teaching on the branchial apparatus.", front:"Contrast the skeletal derivatives of arch 1 vs arch 2.",
      back:"<strong>Arch 1 (V3):</strong> Meckel's cartilage &rarr; malleus + incus; mandible/maxilla; muscles of mastication (\"M\" arch). <strong>Arch 2 (VII):</strong> Reichert's cartilage &rarr; stapes, styloid process, lesser horn + upper hyoid; muscles of facial expression (\"S\" arch)." },
    { id:"branchial-pouch-derivatives-card", tags: ["PE", "embryo"], milestones:["MK1","PC7"], ukmla:"Neck lump", source:"Standard embryology teaching on the branchial apparatus.", front:"Match pouches 1-4 to their adult derivatives.",
      back:"<strong>1</strong> &rarr; middle ear + Eustachian tube; <strong>2</strong> &rarr; palatine tonsil; <strong>3</strong> &rarr; inferior parathyroids + thymus; <strong>4</strong> &rarr; superior parathyroids (+ ultimobranchial body/C cells)." },
    { id:"parathyroid-pouch-inversion-card", tags: ["PE", "embryo"], milestones:["MK1","PC7"], ukmla:"Neck lump", source:"Standard embryology teaching on the branchial apparatus.", front:"Why do the inferior parathyroids come from a lower-numbered pouch than the superior ones?",
      back:"Inferior parathyroids = pouch <strong>3</strong>, superior parathyroids = pouch <strong>4</strong>. Pouch 3 also carries the thymus, which descends and drags the pouch-3 parathyroids inferiorly past the pouch-4 pair. Hook: \"3 travels with the thymus, ends up lower.\"" },
    { id:"digeorge-pouches-card", tags: ["PE", "clinical"], milestones:["MK1","PC7"], redFlag:true, ukmla:"Neck lump", source:"Standard embryology teaching on the branchial apparatus.", front:"DiGeorge syndrome (22q11.2) results from failure of pouches [...], causing which two clinical deficits?",
      back:"Pouches <strong>3 and 4</strong> &rarr; absent thymus (T-cell immunodeficiency) and absent parathyroids (hypocalcemia), often with conotruncal cardiac defects." },
    { id:"branchial-anomaly-internal-opening-card", tags: ["PE", "clinical"], milestones:["PC7","PC3"], ukmla:"Neck lump", source:"Standard pediatric otolaryngology teaching on branchial anomalies.", front:"State the internal opening for 1st, 2nd, and 3rd/4th branchial anomalies.",
      back:"<strong>1st</strong> &rarr; external auditory canal (periauricular/parotid, near CN VII); <strong>2nd</strong> &rarr; tonsillar fossa; <strong>3rd/4th</strong> &rarr; pyriform sinus. Hook: 1 = ear, 2 = tonsil, 3 & 4 = pyriform sinus." },
    { id:"second-branchial-cleft-cyst-tract-card", tags: ["PE", "clinical"], milestones:["PC7","PC3"], ukmla:"Neck lump", source:"Standard pediatric otolaryngology teaching on branchial anomalies.", front:"Describe the classic 2nd branchial cleft cyst and its tract.",
    ...
    { id:"pyriform-sinus-fistula-card", tags: ["PE", "clinical"], milestones:["PC7","PC3"], redFlag:true, ukmla:"Neck lump", source:"Standard pediatric otolaryngology teaching on branchial anomalies.", front:"A child with recurrent left-sided neck abscess or acute suppurative thyroiditis should raise suspicion for [...].",
      back:"A <strong>3rd/4th branchial (pyriform sinus) fistula</strong>, almost always left-sided. Definitive treatment obliterates the pyriform sinus tract (endoscopic cautery or open excision), not just abscess drainage." },
    { id:"first-branchial-cleft-facial-nerve-card", tags: ["PE", "clinical"], milestones:["PC7","PC3"], ukmla:"Neck lump", source:"Standard pediatric otolaryngology teaching on branchial anomalies.", front:"Why is a 1st branchial cleft anomaly higher-stakes surgically than a 2nd?",
    ...
    { id:"branchial-vs-thyroglossal-exam-card", tags: ["PE", "clinical"], milestones:["PC7","PC3"], ukmla:"Neck lump", source:"Standard pediatric otolaryngology teaching on congenital neck masses.", front:"How do you distinguish a branchial cleft cyst from a thyroglossal duct cyst on exam?",
      back:"<strong>Branchial</strong> = lateral, anterior to SCM, does not move with the tongue. <strong>Thyroglossal</strong> = midline, near the hyoid, moves up with tongue protrusion/swallowing; confirm normal thyroid before Sistrunk excision." },
    { id:"waldeyers-ring-components-card", tags: ["PE", "anatomy"], milestones:["MK1","PC7"], ukmla:"Sore throat", source:"Standard pediatric anatomy teaching.", front:"Name the four components of Waldeyer's ring from superior to inferior.",
      back:"<strong>Pharyngeal tonsil</strong> (adenoids, nasopharyngeal roof) &rarr; <strong>tubal tonsils</strong> (around the Eustachian tube openings) &rarr; <strong>palatine tonsils</strong> (tonsillar fossa, seen on oral exam) &rarr; <strong>lingual tonsil</strong> (tongue base). Mnemonic: A-T-P-L. The tubal tonsils are the commonly forgotten fourth component." },
    { id:"waldeyers-ring-malt-card", tags: ["PE", "anatomy"], milestones:["MK1","PC7"], ukmla:"Sore throat", source:"Standard pediatric anatomy teaching.", front:"What kind of tissue is Waldeyer's ring, and what makes its antigen sampling distinctive?",
      back:"<strong>Mucosa-associated lymphoid tissue (MALT)</strong> with germinal centers, acting as first-line immune defense at the aerodigestive entrance. It samples antigen through deep epithelial crypts and, unlike lymph nodes, has <strong>no afferent lymphatics</strong> &mdash; antigen crosses the epithelium directly." },
    { id:"waldeyers-ring-age-curve-card", tags: ["PE", "clinical"], milestones:["PC7","MK1"], ukmla:"Sore throat", source:"Standard pediatric anatomy teaching.", front:"Why do tonsil and adenoid problems cluster in early childhood?",
    ...
    { id:"waldeyers-ring-endpoints-card", tags: ["PE", "clinical"], milestones:["PC7","PC9"], ukmla:"Sore throat", source:"Standard pediatric anatomy teaching.", front:"What are the two distinct clinical endpoints of Waldeyer's ring disease?",
      back:"(1) <strong>Recurrent tonsillitis</strong> (repeated palatine tonsil infection &rarr; recurrent-infection indication for tonsillectomy) and (2) <strong>adenotonsillar hypertrophy</strong> causing airway obstruction (snoring, sleep-disordered breathing, pediatric OSA, and Eustachian-tube obstruction &rarr; middle-ear effusion). Obstructive hypertrophy is now the leading indication for T&A." },
    { id:"palatine-tonsil-blood-supply-card", tags: ["PE", "anatomy"], milestones:["MK1","PC9"], ukmla:"Sore throat", source:"Standard pediatric anatomy teaching.", front:"What is the dominant blood supply to the palatine tonsil, and why does it matter?",
      back:"The <strong>tonsillar branch of the facial artery</strong> (with ascending pharyngeal, lingual, and descending palatine contributions), all from the external carotid system. This rich supply explains the post-tonsillectomy hemorrhage risk." }
  ]
});
