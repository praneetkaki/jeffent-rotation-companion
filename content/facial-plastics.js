...
window.JEFFENT.register({
    ...
    notes: [
      {
        ...
        tagline: "The vertical and horizontal bone columns that absorb impact, and why reconstruction restores buttresses, not just fracture lines.",
        html: "<figure class='note-fig' data-credit='Source not yet cited, added by the project owner, replace credit before sharing.'><img class='zoomable' src='assets/img/figures/facial_buttresses.png' alt='Facial buttresses' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Vertical and horizontal facial buttress columns that absorb/transmit force and that reconstructive plating restores.</figcaption></figure><ul><li><strong>Buttresses</strong> are thickened bone columns that absorb and transmit force: vertical (nasomaxillary, zygomaticomaxillary, pterygomaxillary) and horizontal (frontal bar, infraorbital rim, maxillary alveolus).</li><li>Reconstructive plating re-establishes these buttresses rather than patching individual fracture lines.</li><li>Restoring buttress continuity restores facial height, width, and projection.</li></ul>"
      },
      {
        title: "The parotid gland, facial nerve, and Stensen's duct",
        tagline: "How the facial nerve's five branches thread the parotid, and the surface landmark for Stensen's duct.",
        html: "<figure class='note-fig' data-credit='Source not yet cited, added by the project owner, replace credit before sharing.'><img class='zoomable' src='assets/img/figures/parotid_facial_nerve.png' alt='Parotid facial nerve' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Facial nerve trunk and its five branches running through the parotid gland, plus Stensen&#39;s duct course.</figcaption></figure><ul><li>The facial nerve trunk exits the <strong>stylomastoid foramen</strong> and runs <strong>through the parotid</strong>, dividing it (surgically) into superficial and deep lobes.</li><li>It branches into five named branches: <strong>temporal, zygomatic, buccal, marginal mandibular, cervical</strong>.</li><li><strong>Stensen's duct</strong> runs from the tragus toward the midpoint of the upper lip, over masseter, then pierces buccinator to enter the mouth opposite the second upper molar (a useful landmark for a line of injury).</li></ul>"
      },
      {
        title: "The frontal branch of the facial nerve and Pitanguy's line",
        tagline: "The most vulnerable facial nerve branch, and the surface line that marks where a laceration risks brow ptosis.",
        html: "<figure class='note-fig' data-credit='Source not yet cited, added by the project owner, replace credit before sharing.'><img class='zoomable' src='assets/img/figures/pitanguy_line.png' alt='Pitanguy line' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>The temporal (frontal) branch of the facial nerve and Pitanguy&#39;s surface-marking line that approximates its course.</figcaption></figure><ul><li>The <strong>temporal (frontal) branch</strong> is the most superficial and vulnerable branch, running just under the temporoparietal fascia.</li><li><strong>Pitanguy's line</strong> (0.5 cm below the tragus to 1.5 cm above the lateral eyebrow) approximates its course.</li><li>Lacerations or incisions crossing this line risk brow ptosis from frontal branch injury.</li></ul>"
      },
      {
        title: "Orbital floor and the inferior rectus/orbital fat",
        tagline: "Why the thin orbital floor is the classic blow-out site, and how entrapment produces enophthalmos and diplopia.",
  ...
  clinical: {
    blocks: [
      ...
      },
      {
        ...
        html: "<p>Describes patterns of midface fracture through the pterygoid plates, distinguished by the level of the fracture line, not a strict hierarchy of severity, and patterns can be mixed/asymmetric.</p><figure class='note-fig' data-credit='Source not yet cited, added by the project owner, replace credit before sharing.'><img class='zoomable' src='assets/img/figures/le_fort_fractures.png' alt='Le fort fractures' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Le Fort I, II, and III midface fracture patterns distinguished by fracture line level.</figcaption></figure>",
        table: {
      ...
      },
      {
        ...
        html: "<p>A cooperative, alert patient's voluntary facial movement is the best test, but when the patient is obtunded, intubated, or the exam is otherwise equivocal, <strong>electrodiagnostic testing</strong> helps decide observation vs exploration. A <strong>nerve stimulator</strong> applied to the distal (peripheral) branches can still evoke a motor response for roughly 72 hours after injury even if the nerve is transected, because the distal segment hasn't yet undergone Wallerian degeneration. A response present at this stage doesn't rule out transection. <strong>Electroneuronography (ENoG)</strong> compares the amplitude of the evoked compound muscle action potential on the injured side to the normal side; a drop of <strong>&gt;90%</strong> is generally taken as a threshold favoring surgical exploration/decompression, most classically used in the analogous setting of temporal-bone facial nerve injury and severe Bell's palsy, but the same electrodiagnostic logic applies to extratemporal trauma when the injury site and timing are uncertain. Note that the &gt;90% ENoG threshold is <strong>decision-support, not an automatic trigger</strong>: prospective data show near-universal recovery to House-Brackmann I-II with steroids alone in complete post-traumatic palsy from undisplaced temporal bone fractures, even at &lt;5% ENoG response. The threshold is most useful in displaced or suspected transecting injuries.</p>"
      }
    ],
    redFlags: [
  ...
  cases: [
    {
      ...
      teaching: "<figure class='note-fig' data-credit='Source not yet cited, added by the project owner, replace credit before sharing.'><img class='zoomable' src='assets/img/figures/le_fort_fractures.png' alt='Le fort fractures' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>A mobile midface moving with the nasal complex, classic for Le Fort II fracture, assessed after ATLS priorities.</figcaption></figure>Midface mobility tested by grasping the maxillary alveolus is how Le Fort patterns are distinguished clinically, but ATLS priorities come first regardless of fracture pattern."
    },
    {
      ...
      teaching: "<figure class='note-fig' data-credit='Source not yet cited, added by the project owner, replace credit before sharing.'><img class='zoomable' src='assets/img/figures/facial_nerve_course.png' alt='Facial nerve course' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Immediate complete facial paralysis after a penetrating preauricular knife wound indicating nerve transection needing urgent exploration.</figcaption></figure>Timing and completeness of facial weakness after trauma, not just the fact of weakness, determines whether this is an urgent surgical exploration or a watch-and-wait."
    },
    {
    ...
    },
    {
      ...
      teaching: "<figure class='note-fig' data-credit='Source not yet cited, added by the project owner, replace credit before sharing.'><img class='zoomable' src='assets/img/figures/parotid_facial_nerve.png' alt='Parotid facial nerve' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Cheek laceration with clear salivary drainage indicating Stensen&#39;s duct injury, with concurrent buccal nerve risk.</figcaption></figure>A cheek laceration along the tragus-to-lip-corner line threatens two structures at once, duct and nerve, and both need to be checked before you close."
    },
    {
    ...
    },
    {
      ...
      teaching: "<figure class='note-fig' data-credit='Source not yet cited, added by the project owner, replace credit before sharing.'><img class='zoomable' src='assets/img/figures/mandible_anatomy.png' alt='Mandible anatomy' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Bilateral condylar mandible fracture with symphyseal fracture and bilateral numb chin sign from a chin-first fall.</figcaption></figure>A chin-first mechanism plus malocclusion and trismus should make you look bilaterally, not just at the obvious symphyseal fracture: the mandible rarely breaks in only one place."
    },
    {
    ...
    },
    {
      ...
      teaching: "<figure class='note-fig' data-credit='Source not yet cited, added by the project owner, replace credit before sharing.'><img class='zoomable' src='assets/img/figures/mandible_anatomy.png' alt='Mandible anatomy' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Bilateral parasymphyseal mandible fracture causing tongue-base airway obstruction requiring airway management before fixation.</figcaption></figure>Bilateral mandible fracture is an airway diagnosis before it is an orthopedic one. Tongue-base collapse from a flail anterior segment can obstruct the airway well before anyone gets to fixing the bone, especially supine or sedated."
    },
    {
  ...
  cards: [
    ...
    { id:"reconstructive-ladder-card", tags: ["FP", "clinical"], milestones:["PC9","MK2"], ukmla:"Facial/periorbital swelling", source:"Standard reconstructive surgery teaching: the reconstructive ladder.", front:"State the reconstructive ladder in order.",
      back:"<strong>Secondary intention → primary closure → skin graft → local flap → regional flap → free tissue transfer (microvascular free flap)</strong>. Choose the simplest option achieving a good result, escalating only as the defect and tissue needs require.<figure class='note-fig' data-credit='Source not yet cited, added by the project owner, replace credit before sharing.'><img class='zoomable' src='assets/img/figures/reconstructive_ladder.png' alt='Reconstructive ladder' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>The reconstructive ladder from secondary intention to free tissue transfer.</figcaption></figure>" },
    ...
    { id:"nasal-bone-fracture-card", tags: ["FP", "clinical"], milestones:["PC9","PC1"], ukmla:"Epistaxis", source:"Standard nasal trauma teaching.", front:"What is the general timing for closed reduction of a nasal bone fracture, and why does timing matter?",
      back:"Typically within <strong>5-10 days</strong> in adults (sooner in children, whose bones heal faster), before the fracture fragments begin to fixate or heal in a malaligned position, after which closed reduction becomes ineffective and open techniques may be needed. When the <strong>septum is involved</strong>, a 2025 systematic review/meta-analysis found early open septoplasty roughly halved persistent obstruction (~6% vs ~22%) and reduced 3-year revision rates (~6% vs ~31%) versus closed reduction alone &mdash; so consider early septal correction rather than closed reduction alone for nasoseptal fractures." },
    ...
    { id:"facial-bite-card", tags: ["FP", "clinical"], milestones:["PC9","SBP1"], ukmla:"Facial/periorbital swelling", source:"Ortiz & Lezcano, Am Fam Physician, 2023; Maurer et al., J Clin Med, 2023.", front:"First-line antibiotic prophylaxis for a facial bite wound, and why are facial bites closed differently from bites elsewhere?",
      back:"<strong>Amoxicillin-clavulanate</strong> (covers <em>Pasteurella</em>, <em>Eikenella</em>, <em>Capnocytophaga</em>, oral anaerobes). Unlike bites elsewhere, well-irrigated facial bite wounds are usually closed primarily because of the face's vascularity and cosmetic stakes. Address rabies and tetanus." },
    ...
    { id:"mandible-fracture-sites-card", tags: ["FP", "anatomy"], milestones:["MK1","PC2"], ukmla:"Facial/periorbital swelling", source:"Standard oral-maxillofacial trauma teaching (AO/ATLS facial trauma principles) on mandible fracture sites.", front:"Because the mandible is a ring of bone, a strong enough force often fractures it in <span class=\"cloze-blank\">[...]</span>, for example a symphyseal fracture with a contralateral condyle fracture.",
      back:"Because the mandible is a ring of bone, a strong enough force often fractures it in <mark class=\"cloze-answer\">two places at once</mark>, for example a symphyseal fracture with a contralateral condyle fracture. This is why the whole mandible should be imaged after finding one fracture.<figure class='note-fig' data-credit='Source not yet cited, added by the project owner, replace credit before sharing.'><img class='zoomable' src='assets/img/figures/mandible_anatomy.png' alt='Mandible anatomy' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>The mandible as a ring of bone that often fractures in two places at once.</figcaption></figure>" },
    { id:"mandible-antibiotics-card", tags: ["FP", "clinical"], milestones:["PC9","SBP1"], ukmla:"Facial/periorbital swelling", source:"Coccolini et al., Global Alliance guideline, J Trauma Acute Care Surg, 2024; Appelbaum et al., AAST consensus, Trauma Surg Acute Care Open, 2023.", front:"Which mandible fractures need antibiotic prophylaxis, and for how long after repair?",
      back:"Fractures through the <strong>dentate segment</strong> (angle, body, parasymphysis, symphysis) are open to the mouth and contaminated &mdash; give perioperative antibiotics, continued <strong>&le;24 h after repair</strong> (no benefit beyond). Non-dentate condylar/ramus fractures generally don't require it." },
