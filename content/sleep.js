...
window.JEFFENT.register({
  ...
  anatomy: {
    notes: [
      ...
      },
      {
        ...
        html: "<figure class='note-fig' data-credit='Add figure citation'><img class='zoomable' src='assets/img/figures/Friedman_tongue.png' alt='Friedman tongue' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Friedman tongue position grades I-IV and how they predict UPPP response.</figcaption></figure>" +
          "<p><strong>The exam: how it's done:</strong> the Friedman tongue position (FTP), sometimes called the modified Mallampati index in this context, grades how much the tongue base obscures the palate, tonsils, and uvula on oral exam.</p>" +
          ...
          "<p>Classic Mallampati has the patient protrude the tongue instead: a different test for a different purpose, predicting intubation difficulty.</p>" +
          "<p>The grade is invalid if the patient phonates (\"ahh\") or protrudes the tongue during assessment.</p>" +
          "<p><strong>What each tongue position shows</strong>: grade by the most posterior structure you can still see:</p>" +
          ...
          "<p>As the grade rises, the tongue base progressively obscures the view, ascending from tonsils &rarr; uvula &rarr; soft palate &rarr; hard palate. Less visualized structure corresponds to a higher grade and a worse airway.</p>" +
          "<p>Clinically, FTP III-IV correlates with retrolingual (tongue-base) obstruction, while FTP I-II usually does not: exactly why high grades predict that palate-only surgery will miss the problem.</p>" +
          "<p><strong>The full staging system: tongue position + tonsils + BMI:</strong> FTP alone is one of three ingredients in the Friedman staging system: (1) Friedman tongue/palate position (I-IV), (2) tonsil size (Brodsky grade 0-4), (3) BMI (cutoff of 40 kg/m&sup2;).</p>" +
          ...
          "</tbody></table>" +
          "<p>Palate surgery is most effective when bulky palatine tissue is the primary obstruction and the tongue base is not involved (Stage I); outcomes are poor when tonsils are small and the tongue base is the dominant obstruction (Stage III).</p>" +
          "<p><strong>Predicting Palate Surgery Success</strong>: staging answers one question before offering uvulopalatopharyngoplasty (UPPP): is the obstruction at the palate (addressable by UPPP) or the tongue base (not addressable by UPPP)?</p>" +
          ...
          "<p><em>One-liner: \"Anatomy predicts UPPP success better than AHI does\": how bad the numbers are matters less than where the obstruction sits.</em></p>" +
          "<p><strong>Caveats:</strong> inter-examiner agreement is imperfect (the tongue and palate are mobile, so grading varies between examiners): treat FTP as a useful screen, not a precision measurement. It also does not replace DISE (drug-induced sleep endoscopy): Friedman staging is a clinic-chair predictor, while DISE directly visualizes the level(s) of collapse and is what ultimately tailors surgery.</p>"
      },
      {
        id: "hgns-anatomy",
        title: "The hypoglossal nerve and tongue protrusion",
        tagline: "CN XII · Medial/lateral branch split · Hypoglossal stimulation",
        html: "<figure class='note-fig' data-credit='Add figure citation'><img class='zoomable' src='assets/img/figures/hypoglossal_nerve_branches.png' alt='Hypoglossal nerve branches' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>CN XII course and genioglossus innervation underlying tongue protrusion and its role in OSA/airway patency.</figcaption></figure>" +
          "<p><strong>CN XII is the pure motor nerve of the tongue</strong>: the nerve that keeps the tongue from falling back and blocking the airway in sleep.</p>" +
          ...
          "<p>Palatoglossus is named as a tongue muscle but functions as a palate muscle.</p>" +
          ...
          "<p>Genioglossus protrudes the tongue; hyoglossus and styloglossus retract it. This functional split is the anatomic basis for stimulator targeting.</p>" +
          ...
          "<p>Clinical point: this long, exposed course is why CN XII palsy has so many causes: skull-base tumor, carotid dissection, carotid endarterectomy injury, neck surgery/trauma.</p>" +
          "<p><strong>C1/ansa cervicalis hitchhikers:</strong> in the neck the nerve carries along C1 fibers that peel off to supply geniohyoid and thyrohyoid, and, via the ansa cervicalis, the infrahyoid strap muscles. These aren't \"true\" CN XII fibers: they just travel with it.</p>" +
          "<p><strong>The lesion sign:</strong> a unilateral CN XII lesion makes the protruded tongue deviate <strong>toward</strong> the weak (lesion) side: the intact genioglossus on the normal side pushes the tongue across. Chronic lesions show ipsilateral atrophy and fasciculations.</p>" +
          "<p><strong>Inclusion vs. Exclusion Branches: Cuff Placement</strong>: CN XII is a pure motor nerve. Distal to its main trunk it divides into a <strong>medial division</strong> and a <strong>lateral division</strong>, which do opposite things to the tongue.</p><ul>" +
          "<li><strong>Medial branches &rarr; protrusors</strong> (genioglossus, plus geniohyoid/intrinsic protrusive muscles, with a C1 contribution). Stimulating these protrudes and stiffens the tongue, opening the retrolingual airway. These are the <strong>'inclusion' branches</strong>: the stimulation cuff is placed to capture them.</li>" +
          "<li><strong>Lateral branches &rarr; retractors</strong> (hyoglossus, styloglossus). Stimulating these retracts the tongue (counterproductive), so they are the <strong>'exclusion' branches</strong>: deliberately kept out of the cuff.</li></ul>" +
      ...
      },
      {
        ...
        html: "<figure class='note-fig' data-credit='Add figure citation'><img class='zoomable' src='assets/img/figures/CPAP_therapy.png' alt='CPAP therapy' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>CPAP as pneumatic splinting of the collapsible upper airway.</figcaption></figure>" +
          "<p><strong>How CPAP works:</strong> continuous positive airway pressure delivers a constant column of pressurized room air through a mask, acting as a <strong>pneumatic splint</strong>: positive intraluminal pressure holds the collapsible pharyngeal airway open throughout the respiratory cycle.</p>" +
          ...
          "<p><strong>Adherence: the number that defines \"CPAP failure\":</strong> CPAP only works if worn. The widely used (CMS/insurer) adherence definition is <strong>&ge;4 hours/night on &ge;70% of nights</strong> over a 30-day period.</p>" +
          ...
          "<p><strong>CPAP Intolerance and the ENT Role</strong>: roughly a third to half of patients struggle to adhere. Common reasons include mask discomfort/leak, claustrophobia, aerophagia (swallowed air), and pressure intolerance.</p>" +
          ...
          "<ul><li><strong>Adjunctive (rescue CPAP):</strong> nasal surgery (septoplasty, turbinate reduction, valve repair) rarely cures OSA alone but lowers nasal resistance and improves CPAP tolerance/adherence: the most common ENT contribution.</li>" +
    ...
    blocks: [
      ...
      },
      {
        ...
        html: "<p><strong>Core principle:</strong> OSA treatment is a ladder, not a menu. Start with the option that reliably works regardless of where the airway collapses, and escalate only when it fails.</p>" +
          ...
          "<p><strong>Worked example: how a real patient moves down the ladder:</strong></p>" +
          ...
          "<p><strong>If heading toward surgery:</strong> DISE identifies the collapse site(s), which selects the operation: e.g. isolated retropalatal collapse &rarr; palate surgery; tongue-base collapse without complete concentric palatal collapse &rarr; hypoglossal nerve stimulation candidate.</p>" +
          "<p><em>Teaching point: the ladder is iterative: most of the clinical work happens at the \"reassess and troubleshoot\" step, not the jump to surgery.</em></p>" +
          ...
          "<p><strong>Rationale</strong>: surgical planning requires knowing where the airway collapses, unlike CPAP. An awake exam (e.g. Muller maneuver) poorly predicts what happens during sleep. DISE dynamically localizes the obstruction so the operation targets the correct level.</p>" +
          "<p>What it reports: collapse graded by level and pattern, commonly using the <strong>VOTE classification</strong> (Velum/palate, Oropharynx/lateral walls, Tongue base, Epiglottis), noting degree (none/partial/complete) and configuration (anteroposterior, lateral, concentric) at each site.</p>" +
          "<p><strong>Complete concentric collapse at the velum/palate is a contraindication to hypoglossal nerve stimulation</strong>; DISE is mandatory before HGNS to exclude this pattern.</p>" +
      ...
      },
      {
        ...
        html: "<p>An implanted device that treats OSA by electrically firing the hypoglossal nerve in time with breathing, contracting the genioglossus so the tongue protrudes and stiffens and the airway stays open: an <strong>active splint</strong>, in contrast to CPAP's <strong>pneumatic splint</strong>.</p>" +
          ...
          "<p><strong>Inclusion vs. exclusion branches: why cuff placement is everything:</strong> CN XII is pure motor, and distal to its trunk it splits into a medial division and lateral division that do opposite things.</p>" +
          ...
          "<p><strong>Practical operative points:</strong> intraoperative EMG/nerve integrity monitoring confirms genioglossus (protrusion) activation without hyoglossus/styloglossus (retraction) before the cuff is secured: the surgeon looks for the tongue to protrude, not retract. Bipolar (not monopolar) cautery is used near the device to avoid damaging it.</p>" +
          ...
          "<li>AHI in the approved range (originally 15-65, upper limit since expanded: confirm current device labeling)</li>" +
          "<li>BMI below threshold (originally &le;32, many payers/labels now allow &lt;35, up to &lt;40 in updated criteria: verify against current guidance)</li>" +
          ...
          "<ul><li>Complete concentric collapse of the velum/palate on DISE (the single most important exclusion: the collapse is too circumferential for tongue protrusion to overcome)</li>" +
          ...
          "<p><strong>DISE Findings and HGNS Candidacy</strong>: tongue-base/retrolingual (anteroposterior) collapse responds well to hypoglossal nerve stimulation; complete concentric palatal collapse does not, so every candidate undergoes drug-induced sleep endoscopy first.</p>" +
      ...
      },
      {
        ...
        html: "<ul><li><strong>Complete concentric collapse (CCC)</strong> at the velum on DISE (the classic disqualifier: tongue protrusion cannot overcome circumferential palatal collapse driven by the lateral walls)</li><li>Central or mixed apneas &ge;25% of the AHI</li><li>BMI above threshold</li><li>AHI above the labeled ceiling</li><li>Neurologic conditions or prior upper-airway surgery limiting tongue/airway control</li><li>Inability to operate the patient controller</li><li>Pregnancy or plans to become pregnant</li><li>Need for MRI incompatible with the device</li><li>Severe obstructive/restrictive lung disease</li></ul><p>Note: oropharyngeal lateral-wall collapse on DISE, while not an absolute contraindication, predicts reduced efficacy.</p>"
      },
      {
  ...
  cards: [
    ...
    { id:"hgns-mechanism-card", tags: ["SL", "clinical"], milestones:["PC9","MK2"], ukmla:"Obstructive sleep apnoea", source:"AAO-HNSF Position Statement: Hypoglossal Nerve Stimulation for OSA.", front:"How does hypoglossal nerve stimulation keep the airway open in OSA?",
      back:"An implanted cuff electrode fires the hypoglossal nerve in phase with inspiration, contracting the genioglossus to protrude/stiffen the tongue and open the retrolingual airway: an <strong>active splint</strong>, versus CPAP's <strong>pneumatic splint</strong>." },
    { id:"hgns-inclusion-exclusion-card", tags: ["SL", "anatomy"], milestones:["MK1","PC9"], redFlag:true, ukmla:"Obstructive sleep apnoea", source:"Sturm et al., Laryngoscope, 2020; Bassiri Gharb et al., Neuromodulation, 2015.", front:"In HGNS, which hypoglossal branches are 'included' in the cuff and which are 'excluded,' and why?",
      back:"<strong>Include medial branches</strong> (protrusors: genioglossus): they open the airway. <strong>Exclude lateral branches</strong> (retractors: hyoglossus, styloglossus): they retract the tongue. Intraoperative EMG confirms protrusion, not retraction, before securing the cuff; bipolar (not monopolar) cautery is used near the device." },
