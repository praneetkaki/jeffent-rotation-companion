  ...
  anatomy: {
    notes: [
      ...
      },
      {
        ...
        html: "<div class=\"fig-row\"><figure class='note-fig' data-credit=\"Nasal cavity, sagittal view. Source not yet cited, added by the project owner, replace credit before sharing.\"><img class='zoomable' src='assets/img/mc/nasal-cavity-sagittal-usersrc.png' alt='Nasal cavity, sagittal section' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>The nasal cavity in sagittal section.</figcaption></figure></div><ul><li>Three turbinates (inferior, middle, superior) form the meatuses on the lateral nasal wall.</li><li>The frontal, anterior ethmoid, and maxillary sinuses drain into the <strong>middle meatus</strong> through the <strong>ostiomeatal complex (OMC)</strong>; block it and you get sinusitis.</li><li>The sinuses border the <strong>orbit</strong> and <strong>anterior skull base</strong>, so infection can spread to the eye or brain.</li></ul>"
      },
      {
