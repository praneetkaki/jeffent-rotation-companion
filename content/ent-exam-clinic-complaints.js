...
window.JEFFENT.register({
    ...
    notes: [
      {
        ...
        html: "<div class=\"fig-row\"><figure class='note-fig' data-credit='Source not yet cited, added by the project owner, replace credit before sharing.'><img class='zoomable' src='assets/img/figures/ENT_regions_glance.png' alt='ENT regions glance' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Overview map of the five linked ENT anatomical regions (ear, nose/sinuses, oral cavity/pharynx, larynx, neck).</figcaption></figure></div><p>ENT anatomy breaks down into five linked regions. Learn the map here, then go deep in each track.</p>" +
          ...
          "<li><strong><a class='xref' data-mod='head-neck-oncology' data-tab='anatomy'>Neck</a>:</strong> anterior/posterior triangles, nodal levels I-VI (plus level VII, superior mediastinal), thyroid and salivary glands.</li></ul>"
      },
      {
        ...
        html: "<div class=\"fig-row\"><figure class='note-fig' data-credit='Source not yet cited, added by the project owner, replace credit before sharing.'><img class='zoomable' src='assets/img/figures/cranial-nerves-inferior-view.svg' alt='Cranial nerves inferior view' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>All twelve cranial nerves with their skull-base exit foramen and function.</figcaption></figure></div><p>All twelve cranial nerves, in order, with the skull base foramen or canal each one exits through and why it matters clinically. This is the complete reference; see the diagram below for where each foramen actually sits.</p>" +
          ...
          "<tr><td><strong>VII</strong> &middot; Facial</td><td>Internal acoustic meatus (traverses the temporal bone; exits the skull at the stylomastoid foramen)</td><td>Facial movement, taste (anterior two-thirds of tongue), lacrimation and salivation</td></tr>" +
  ...
  cases: [
    ...
    },
    {
      ...
      teaching: "<figure class='note-fig' data-credit='Source not yet cited, added by the project owner, replace credit before sharing.'><img class='zoomable' src='assets/img/figures/peritonsilllar abscess.png' alt='Peritonsilllar abscess' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Peritonsillar abscess presenting with trismus, muffled voice, and drooling; airway first, then drainage.</figcaption></figure>Muffled voice + trismus + drooling = think abscess and airway before anything else."
    },
    {
      id: "case-neck-mass",
      ukmla: "Neck lump",
    ...
    },
    {
      ...
      teaching: "<figure class='note-fig' data-credit='Source not yet cited, added by the project owner, replace credit before sharing.'><img class='zoomable' src='assets/img/figures/epistaxis_mgmt.png' alt='Epistaxis mgmt' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Anterior epistaxis on anticoagulation managed with compression, topical vasoconstrictor, and INR check.</figcaption></figure>Pressure on the soft part of the nose, not the bony bridge, stops most nosebleeds. Always check anticoagulation."
    },
    {
      id: "case-bppv",
  ...
  cards: [
    ...
    { id:"tympanometry", tags: ["FN", "clinical"], milestones:["PC4"], ukmla:"Hearing loss", source:"Jerger, tympanogram classification, Archives of Otolaryngology 1970.", front:"What do tympanometry types A, B, and C mean?",
      back:"<strong>A</strong> = normal middle-ear pressure/compliance. <strong>B</strong> = flat: middle-ear <strong>effusion</strong> or perforation. <figure class='note-fig' data-credit='Source not yet cited, added by the project owner, replace credit before sharing.'><img class='zoomable' src='assets/img/figures/tympanograms.png' alt='Tympanograms' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Tympanogram types A, B, C and the ear conditions each indicates.</figcaption></figure>" },
    ...
    { id:"pta", tags: ["FN", "clinical"], milestones:["PC1","PC6"], redFlag:true, ukmla:"Sore throat", source:"AAO-HNS patient education: peritonsillar abscess management.", front:"What triad suggests a peritonsillar abscess?",
      back:"<strong>Trismus</strong>, <strong>'hot potato' muffled voice</strong>, and <strong>uvular deviation</strong> away from a swollen peritonsil region. Needs <strong>drainage</strong> (needle/I&amp;D) + antibiotics; watch the airway and deep-neck spread.<figure class='note-fig' data-credit='Source not yet cited, added by the project owner, replace credit before sharing.'><img class='zoomable' src='assets/img/figures/peritonsilllar abscess.png' alt='Peritonsilllar abscess' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Peritonsillar abscess triad (trismus, muffled voice, uvular deviation) and management.</figcaption></figure>" },
