...
window.JEFFENT.register({
  ...
  anatomy: {
    notes: [
      {
        ...
        html: "<figure class='note-fig' data-credit=\"The ENT regions at a glance. Illustration generated with Google Gemini.\"><img class='zoomable' src='assets/img/mc/image17.png' alt='Head and neck sagittal overview' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Landmarks: Sagittal overview of ear, nose and sinuses, oral cavity and pharynx, larynx, and neck.</figcaption></figure><figure class='note-fig' data-credit=\"Overview Map of the Five Linked ENT Anatomical Regions. Illustration generated with Google Gemini.\"><img class='zoomable' src='assets/img/mc/16_ent_regions_overview.png' alt='Five ENT anatomical regions overview' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>The five linked ENT anatomical regions.</figcaption></figure><p>ENT anatomy breaks down into five linked regions. Learn the map here, then go deep in each track.</p>" +
      ...
      },
      {
        ...
        html: "<figure class='note-fig' data-credit=\"The twelve cranial nerves, inferior view of the brain. Wikimedia Commons, CC BY-SA 3.0.\"><img class='zoomable' src='assets/img/anatomy-atlas/cranial-nerves-inferior-view.svg' alt='The twelve cranial nerves on the inferior surface of the brain' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>The twelve cranial nerves (inferior view of the brain)</figcaption></figure><p>All twelve cranial nerves, in order, with the skull base foramen or canal each one exits through and why it matters clinically. This is the complete reference; see the diagram below for where each foramen actually sits.</p>" +
          ...
          "</tbody></table></div>" +
          "<figure class='note-fig' data-credit=\"The Twelve Cranial Nerves and Their Skull Base Exits. teachmeanatomy.info.\"><img class='zoomable' src='assets/img/mc/04_cranial_nerves_skull_base_exit.png' alt='Cranial nerves and their skull base exits' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>The twelve cranial nerves and the skull-base foramen each exits through.</figcaption></figure>"
      },
      {
        title: "Nose & paranasal sinuses",
        html: "<figure class='note-fig' data-credit=\"Paranasal sinuses / ostiomeatal complex. Radiopaedia.\"><img class='zoomable' src='assets/img/mc/image18.png' alt='The paranasal sinuses' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>The paranasal sinuses</figcaption></figure><figure class='note-fig' data-credit=\"Ostiomeatal Complex (OMC) Coronal Drainage Anatomy. radiopaedia.org.\"><img class='zoomable' src='assets/img/mc/17_ostiomeatal_complex_radiopaedia.png' alt='Ostiomeatal complex coronal drainage anatomy' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>The ostiomeatal complex in coronal section.</figcaption></figure><ul><li>Three turbinates (inferior, middle, superior) form the meatuses on the lateral nasal wall.</li><li>The frontal, anterior ethmoid, and maxillary sinuses drain into the <strong>middle meatus</strong> through the <strong>ostiomeatal complex (OMC)</strong>; block it and you get sinusitis.</li><li>The sinuses border the <strong>orbit</strong> and <strong>anterior skull base</strong>, so infection can spread to the eye or brain.</li></ul>"
      },
      {
    ...
    diagrams: [
      ...
      },
      {
        ...
        src: "assets/img/mc/19_paranasal_sinuses_coronal_radiopaedia.png",
      ...
      },
      {
        ...
        src: "assets/img/mc/20_larynx_coronal_section.png",
      ...
      },
      {
        ...
        src: "assets/img/mc/21_neck_nodal_levels_i_vi.png",
      ...
      },
      {
        ...
        src: "assets/img/mc/22_tympanic_membrane_normal_oxford.png",
      ...
      },
      {
        ...
        src: "assets/img/mc/23_skull_base_foramina_cranial_nerves_radiopaedia.png",
  ...
  cards: [
    ...
    { id:"neck-levels", tags: ["FN", "clinical"], milestones:["MK1","PC3"], ukmla:"Neck lump", source:"Standard head & neck examination teaching.", front:"How do you structure the neck exam and which nodal levels do you palpate?",
      back:"Region by region: <strong>levels I-VI</strong> (submental/submandibular, upper/mid/lower jugular, posterior triangle, central), plus <strong>thyroid, parotid, supraclavicular</strong>. <figure class='note-fig' data-credit=\"Neck Nodal Levels I-VI Schematic. Wikimedia Commons.\"><img class='zoomable' src='assets/img/mc/21_neck_nodal_levels_i_vi.png' alt='Neck nodal levels I to VI' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Neck nodal levels I to VI.</figcaption></figure>" },
    ...
    { id:"epistaxis", tags: ["FN", "clinical"], milestones:["PC5","PC1"], ukmla:"Epistaxis", source:"AAO-HNSF Clinical Practice Guideline: Nosebleed (Epistaxis), 2020.", front:"Most anterior epistaxis arises from <span class=\"cloze-blank\">[...]</span>, and first-line treatment is firm pressure on the cartilaginous part of the nose plus a topical vasoconstrictor.",
      back:"Most anterior epistaxis arises from <mark class=\"cloze-answer\">Kiesselbach's plexus</mark>, and first-line treatment is firm pressure on the cartilaginous part of the nose plus a topical vasoconstrictor. Posterior bleeds are heavier and more often need packing or admission.<figure class='note-fig' data-credit='Kiesselbach's plexus (Little's area). Illustration generated with Google Gemini.'><img class='zoomable' src='assets/img/mc/image26.png' alt='Kiesselbach's plexus' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Kiesselbach's plexus (Little's area), the source of most anterior nosebleeds.</figcaption></figure><figure class='note-fig' data-credit=\"Kiesselbach's Plexus (Little's Area) Arterial Supply. Illustration generated with Google Gemini.\"><img class='zoomable' src='assets/img/mc/25_kiesselbachs_plexus_gemini.png' alt='Kiesselbach's plexus arterial supply' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Kiesselbach's plexus four-vessel anastomosis.</figcaption></figure>" },
    ...
    { id:"epiglottitis", tags: ["FN", "clinical"], milestones:["PC1","PC7"], redFlag:true, ukmla:["Stridor","Epiglottitis"], source:"IDSA / pediatric infectious-disease guidance on epiglottitis (supraglottitis) management.", front:"What is the classic presentation and the critical DON'T of epiglottitis?",
      back:"Rapid severe sore throat, <strong>drooling</strong>, <strong>tripod</strong> posture, muffled 'hot potato' voice, stridor. <strong>Do NOT examine the throat or lie the (child) patient flat</strong>: it can precipitate airway loss. Controlled airway in theater + IV antibiotics.<figure class='note-fig' data-credit='Acute epiglottitis. Illustration generated with Google Gemini.'><img class='zoomable' src='assets/img/mc/image29.png' alt='Acute epiglottitis guide' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Acute epiglottitis: presentation, red flags, and the airway rule.</figcaption></figure><figure class='note-fig' data-credit=\"Epiglottitis: Classic Presentation and Airway Management. Illustration generated with Google Gemini.\"><img class='zoomable' src='assets/img/mc/28_epiglottitis_presentation_gemini.png' alt='Epiglottitis presentation and airway management' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Epiglottitis: classic presentation and airway management.</figcaption></figure>" },
    { id:"pta", tags: ["FN", "clinical"], milestones:["PC1","PC6"], redFlag:true, ukmla:"Sore throat", source:"AAO-HNS patient education: peritonsillar abscess management.", front:"What triad suggests a peritonsillar abscess?",
      back:"<strong>Trismus</strong>, <strong>'hot potato' muffled voice</strong>, and <strong>uvular deviation</strong> away from a swollen peritonsil region. Needs <strong>drainage</strong> (needle/I&amp;D) + antibiotics; watch the airway and deep-neck spread.<figure class='note-fig' data-credit='Peritonsillar abscess. Illustration generated with Google Gemini.'><img class='zoomable' src='assets/img/mc/image30.png' alt='Peritonsillar abscess guide' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Peritonsillar abscess: the classic triad and management.</figcaption></figure><figure class='note-fig' data-credit=\"Peritonsillar Abscess Triad. Illustration generated with Google Gemini.\"><img class='zoomable' src='assets/img/mc/29_peritonsillar_abscess_triad_gemini.png' alt='Peritonsillar abscess triad' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Peritonsillar abscess triad: trismus, hot potato voice, uvular deviation.</figcaption></figure>" },
    ...
    { id:"sinusitis-complications", tags: ["FN", "clinical"], milestones:["PC5"], redFlag:true, ukmla:["Facial/periorbital swelling","Rhinosinusitis"], source:"Chandler et al., Laryngoscope 1970; AAO-HNSF Adult Sinusitis CPG, 2015.", front:"What complications of sinusitis must you not miss?",
      back:"<strong>Orbital:</strong> proptosis, <strong>painful/limited eye movement, reduced acuity</strong> (orbital cellulitis/abscess). <strong>Intracranial:</strong> meningitis, abscess, cavernous sinus thrombosis; <strong>Pott's puffy tumor</strong> (frontal). Urgent contrast CT + IV antibiotics ± surgery.<figure class='note-fig' data-credit='Complications of sinusitis. Illustration generated with Google Gemini.'><img class='zoomable' src='assets/img/mc/image31.png' alt='Sinusitis complications' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Complications of sinusitis: orbital and intracranial spread.</figcaption></figure><figure class='note-fig' data-credit=\"Complications of Sinusitis (Orbital and Intracranial). Illustration generated with Google Gemini.\"><img class='zoomable' src='assets/img/mc/30_sinusitis_complications_orbital_gemini.png' alt='Complications of sinusitis' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Complications of sinusitis: orbital and intracranial spread.</figcaption></figure>" },
