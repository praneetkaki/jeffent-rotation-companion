...
window.JEFFENT.register({
    ...
    notes: [
      {
        ...
        html:
          ...
          "<li><strong>Middle:</strong> tympanic membrane → ossicles (<strong>malleus → incus → stapes</strong>) → oval window; connected to the nasopharynx by the Eustachian tube.</li>" +
          "<li><strong>Inner:</strong> cochlea (hearing) and <strong>vestibule + semicircular canals</strong> (balance), read out by <strong>CN VIII</strong>.</li>" +
          "</ul>"
      },
      {
        ...
        html:
          "<figure class='note-fig' data-credit='Add figure citation'><img class='zoomable' src='assets/img/figures/middle_ear_dangerous_relationships.png' alt='Middle ear dangerous relationships' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Middle-ear/mastoid danger zone: facial nerve, tensor tympani/stapedius, chorda tympani, and referred otalgia via CN V/VII/IX/X.</figcaption></figure><ul>" +
          ...
          "<li>Chorda tympani (branch of VII) crosses the middle ear carrying taste from the anterior ⅔ of the tongue.</li>" +
          "</ul>"
      }
    ],
    ...
    blocks: [
      ...
      },
      {
        ...
        html:
          ...
          "<li><strong>Acute otitis media:</strong> middle-ear infection; bulging TM, effusion. <strong>Mastoiditis</strong> is a complication/extension of AOM: infection spreads from the middle ear into the mastoid air cells via the aditus ad antrum, producing postauricular swelling/erythema and an outwardly-displaced auricle; it needs urgent ENT input, not just more oral antibiotics.</li>" +
      ...
      },
      {
        ...
        html:
          "<ul><li><strong>Topical therapy is first-line, not oral antibiotics</strong>: topical agents reach far higher local concentrations, have fewer systemic effects, and limit resistance (AAO-HNS 2014). Most common pathogens: <em>Pseudomonas aeruginosa</em> and <em>Staphylococcus aureus</em>.</li>" +
          ...
          "<li><strong>Oral antibiotics</strong> are reserved for infection spreading beyond the canal (cellulitis), or the immunocompromised/diabetic patient: the same population in whom necrotizing OE must be excluded (see the necrotizing otitis externa block above).</li></ul>"
      },
      {
      ...
      },
      {
        ...
        html:
          ...
          "<ul>" +
          "<li><strong>Acquired (primary):</strong> the common type. Chronic Eustachian tube dysfunction creates negative middle-ear pressure, drawing the pars flaccida (or, less often, the postero-superior pars tensa) inward into a <strong>retraction pocket</strong>. Desquamated keratin accumulates in the pocket instead of migrating out normally, and the sac enlarges.</li>" +
          ...
          "</ul>" +
          "<p><strong>Progressive Bony Erosion</strong>: the sac keeps enlarging regardless of infection control, and its bone-resorbing enzymes progressively erode whatever is nearby, so medical therapy alone does not resolve it:</p>" +
          "<ul>" +
      ...
      },
      {
        ...
        html:
          ...
          "</ul>" +
          "<p><strong>Probable Ménière's disease</strong>: &ge;2 episodes of vertigo or dizziness each lasting <strong>20 minutes to 24 hours</strong> (a wider window than definite MD), fluctuating aural symptoms in the affected ear, and no better explanation: without the requirement for audiometrically documented SNHL.</p>" +
          "<p><strong>Step-up management</strong> (escalate only as needed):</p>" +
          "<ol>" +
          "<li><strong>Lifestyle/dietary:</strong> low-sodium diet and caffeine/alcohol moderation, first-line and low-risk. <strong>Betahistine</strong> is widely used as an adjunct here (especially outside the US) but is not FDA-approved for Ménière's, and evidence is conflicting/low-certainty: the well-designed BEMED RCT found no benefit over placebo, so it is not a guideline-mandated step.</li>" +
  ...
  cases: [
    ...
    },
    {
      ...
      teaching: "<figure class='note-fig' data-credit='Add figure citation'><img class='zoomable' src='assets/img/figures/necrotizing_otitis_externa.png' alt='Necrotizing otitis externa' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Progressive necrotizing otitis externa in a diabetic patient developing facial droop and hoarseness from skull-base spread.</figcaption></figure>New cranial neuropathies in otitis externa aren't a separate diagnosis to chase. They're the same disease spreading along the skull base, and they demand escalation, not another course of drops."
    },
    {
      ...
      teaching: "<figure class='note-fig' data-credit='Add figure citation'><img class='zoomable' src='assets/img/figures/tympanograms.png' alt='Tympanograms' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Bilateral conductive hearing loss with a normal TM, family history, and pregnancy-related worsening, diagnostic of otosclerosis.</figcaption></figure>Bilateral conductive loss with a normal drum, a family history, and a young adult: think otosclerosis before you think 'wax I must have missed.'"
    },
    {
      id: "case-meniere",
    ...
    },
    {
      ...
      teaching: "<figure class='note-fig' data-credit='Add figure citation'><img class='zoomable' src='assets/img/figures/vestibular_schwannoma_MRI.png' alt='Vestibular schwannoma MRI' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Progressive asymmetric SNHL and tinnitus worked up with MRI IAC, revealing a vestibular schwannoma, with management options discussed via House-Brackmann.</figcaption></figure>Vestibular schwannoma is the lesion an asymmetric-SNHL red flag is chasing: progressive unilateral hearing loss, tinnitus, and disequilibrium (not spinning vertigo) should trigger an MRI IAC with contrast, not a repeat audiogram in six months. Once found, the management ladder (observe → radiosurgery → resection) is chosen against the same facial-nerve-preservation tradeoff the House-Brackmann scale is built to describe."
    }
  ],

  /* ==================== CARDS TAB (active recall) ==================== */
  cards: [
    { id: "eac-anat", tags: ["OT", "anatomy"], milestones: ["MK1"], ukmla: ["Painful ear","Hearing loss"], source: "Standard otologic anatomy teaching.", front: "What innervates the external ear, and why is that clinically relevant?",
      back: "The external ear's sensory supply is shared among several nerves, each covering a different patch of the auricle and canal: the <strong>great auricular nerve</strong> (C2-C3) supplies most of the lower auricle and the skin over the mastoid/parotid region; the <strong>auriculotemporal nerve</strong> (CN <strong>V3</strong>) supplies the anterosuperior auricle, tragus, and the anterior/superior EAC and TM; the <strong>lesser occipital nerve</strong> (C2) covers the posterosuperior auricle; the <strong>posterior auricular branch of CN VII</strong> contributes to the auricle and postauricular skin; and <strong>Arnold's nerve</strong>, the auricular branch of CN <strong>X</strong>, supplies part of the concha and the posteroinferior EAC. Because so many nerves converge on one small structure, ear pain is frequently <strong>referred</strong> from distant sites those same nerves also supply (TMJ, teeth, throat, larynx), and stimulating Arnold's nerve in the canal (e.g., on otoscopy or cerumen removal) can trigger a vagally-mediated cough reflex (Arnold's/ear-cough reflex)." },
    ...
    { id: "ossicles", tags: ["OT", "anatomy"], milestones: ["MK1"], ukmla: "Hearing loss", source: "Standard otologic anatomy teaching.", front: "Name the ossicular chain in order and what it connects.", back: "<strong>Malleus → incus → stapes → oval window.</strong> It mechanically transmits and amplifies TM vibration into the cochlear fluid.<figure class='note-fig' data-credit='Add figure citation'><img class='zoomable' src='assets/img/figures/ossicles_joints.png' alt='Ossicles joints' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>The ossicular chain (malleus, incus, stapes) and its mechanical connection from TM to oval window.</figcaption></figure>" },
    { id: "me-muscles", tags: ["OT", "anatomy"], milestones: ["MK1"], ukmla: "Hearing loss", source: "Standard otologic anatomy teaching.", front: "What are the two middle-ear muscles, their nerves, and their function?", back: "<strong>Tensor tympani</strong> (CN V3) and <strong>stapedius</strong> (CN VII). They reflexively <strong>dampen loud sounds</strong> (acoustic reflex). Because the stapedius mediates the acoustic reflex, a facial nerve palsy proximal to the stapedial branch can cause <strong>hyperacusis</strong>: a common pimp point linking this anatomy to the facial-palsy cards.<figure class='note-fig' data-credit='Add figure citation'><img class='zoomable' src='assets/img/figures/middle_ear_dangerous_relationships.png' alt='Middle ear dangerous relationships' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Tensor tympani (CN V3) and stapedius (CN VII), the two middle-ear muscles and the acoustic reflex.</figcaption></figure>" },
    ...
    { id: "cn7-me", tags: ["OT", "anatomy"], milestones: ["MK1","PC4"], ukmla: "Facial weakness", source: "Standard otologic anatomy teaching.", front: "What is the relevance of the facial nerve in otology?", back: "<strong>CN VII</strong> courses through the temporal bone adjacent to the middle/inner ear, so it's at risk from cholesteatoma, tumor, necrotizing otitis externa, and surgery. <strong>Facial weakness + ear disease = red flag.</strong><figure class='note-fig' data-credit='Add figure citation'><img class='zoomable' src='assets/img/figures/facial_nerve_ear_otology.png' alt='Facial nerve ear otology' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Facial nerve course through the temporal bone and vulnerability to otologic disease.</figcaption></figure>" },
    { id: "chorda", tags: ["OT", "anatomy"], milestones: ["MK1"], ukmla: "Hearing loss", source: "Standard otologic anatomy teaching.", front: "What is the chorda tympani and what does it carry?", back: "A branch of <strong>CN VII</strong> that crosses the middle ear carrying <strong>taste from the anterior ⅔ of the tongue</strong> (and parasympathetics to submandibular/sublingual glands).<figure class='note-fig' data-credit='Add figure citation'><img class='zoomable' src='assets/img/figures/facial_nerve_ear_otology.png' alt='Facial nerve ear otology' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>The chorda tympani (CN VII branch) crossing the middle ear, carrying taste from the anterior 2/3 of the tongue.</figcaption></figure>" },
    { id: "inner-div", tags: ["OT", "anatomy"], milestones: ["MK1"], ukmla: ["Hearing loss","Vertigo"], source: "Standard otologic anatomy teaching.", front: "Divide the inner ear by function.", back: "<strong>Cochlea</strong> = hearing; <strong>vestibule + semicircular canals</strong> = balance. Both are read out by <strong>CN VIII</strong> (cochlear + vestibular divisions).<figure class='note-fig' data-credit='Add figure citation'><img class='zoomable' src='assets/img/figures/inner_ear_anatomy.png' alt='Inner ear anatomy' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Dividing the inner ear by function: cochlea (hearing) vs vestibule + semicircular canals (balance), both read by CN VIII.</figcaption></figure>" },
    ...
    { id: "asym-snhl", tags: ["OT", "clinical"], milestones: ["PC4"], redFlag: true, ukmla: ["Hearing loss","Acoustic neuroma"], source: "ACR Appropriateness Criteria: Hearing Loss and/or Vertigo (asymmetric SNHL imaging).", front: "Asymmetric SNHL or unilateral tinnitus: what must you exclude?",
      back: "<strong>Vestibular schwannoma</strong> (and other retrocochlear lesions). Get an <strong>MRI with contrast</strong> of the internal auditory canals.<figure class='note-fig' data-credit='Add figure citation'><img class='zoomable' src='assets/img/figures/vestibular_schwannoma_MRI.png' alt='Vestibular schwannoma MRI' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Asymmetric SNHL or unilateral tinnitus must be worked up with MRI to exclude vestibular schwannoma.</figcaption></figure>" },
    ...
    { id: "cholesteatoma", tags: ["OT", "clinical"], milestones: ["PC4","MK3"], redFlag: true, ukmla: ["Ear and nasal discharge","Otitis media"], source: "Standard otology teaching on cholesteatoma.", front: "What findings suggest cholesteatoma, and why is it clinically relevant?",
    ...
    { id: "bppv", tags: ["OT", "clinical"], milestones: ["PC4"], ukmla: ["Vertigo","Benign paroxysmal positional vertigo"], source: "AAO-HNSF Clinical Practice Guideline: BPPV (Update), 2017.", front: "Classic BPPV: features, test, treatment.", back: "<strong>Brief, seconds-long positional vertigo</strong>; confirm with <strong>Dix-Hallpike</strong>; treat with the <strong>Epley</strong> maneuver. Hearing is normal.<p><strong>Dix-Hallpike:</strong> from sitting, the examiner rapidly moves the patient to supine with the head turned 45&deg; to one side and extended slightly over the end of the table; a positive test reproduces vertigo with the characteristic torsional/upbeating nystagmus of posterior-canal BPPV on that side. <strong>Epley maneuver:</strong> a sequence of head/body repositions starting from the positive Dix-Hallpike position, rotating the head/body stepwise through roughly 180&deg; (affected ear down &rarr; head turned to the other side &rarr; body rolled onto that side facing down &rarr; sit up), designed to walk the displaced otoconia out of the posterior semicircular canal and back into the utricle.</p>" },
