...
window.JEFFENT.register({
    ...
    blocks: [
      ...
      },
      {
        ...
        html:
          ...
          "</ul>" +
          "<p>Facial nerve function is tracked before and after any intervention using the <strong>House-Brackmann grading scale</strong> (Grade I = normal, Grade VI = total paralysis), the standard language for describing facial nerve outcomes in vestibular schwannoma care.</p>" + "<figure class='note-fig' data-credit='Acoustic neuroma (vestibular schwannoma). Wikimedia Commons.'><img class='zoomable' src='assets/img/mc/image37.png' alt='Acoustic neuroma illustration' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Vestibular schwannoma at the cerebellopontine angle, on the cochlear/vestibular nerves.</figcaption></figure>" + "<figure class='note-fig' data-credit='Vestibular schwannoma on axial MRI. Wikimedia Commons.'><img class='zoomable' src='assets/img/mc/image38.png' alt='Vestibular schwannoma on axial MRI' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>The same lesion on contrast-enhanced axial MRI of the internal auditory canal.</figcaption></figure><figure class='note-fig' data-credit=\"Vestibular Schwannoma on Contrast-Enhanced Axial MRI. Wikimedia Commons.\"><img class='zoomable' src='assets/img/mc/36a_vestibular_schwannoma_mri_wikimedia.png' alt='Vestibular schwannoma on axial MRI' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Vestibular schwannoma on contrast-enhanced axial MRI.</figcaption></figure><figure class='note-fig' data-credit=\"Vestibular Schwannoma Gross Resection Specimen. Wikimedia Commons.\"><img class='zoomable' src='assets/img/mc/36b_vestibular_schwannoma_gross_wikimedia.png' alt='Vestibular schwannoma gross specimen' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Vestibular schwannoma gross resection specimen.</figcaption></figure>"
      },
      {
  ...
  cases: [
    ...
    },
    {
      ...
      teaching: "Painless, chronic, foul otorrhea + retraction/attic crust = cholesteatoma until proven otherwise.<figure class='note-fig' data-credit=\"Cholesteatoma with Large Left Tympanic Membrane Perforation. Wikimedia Commons.\"><img class='zoomable' src='assets/img/mc/35_cholesteatoma_tm_perforation_wikimedia.png' alt='Cholesteatoma, otoscopic view' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Cholesteatoma with a large tympanic membrane perforation.</figcaption></figure>"
    },
    {
      id: "case-bppv",
  ...
  cards: [
    ...
    { id: "asym-snhl", tags: ["OT", "clinical"], milestones: ["PC4"], redFlag: true, ukmla: ["Hearing loss","Acoustic neuroma"], source: "ACR Appropriateness Criteria: Hearing Loss and/or Vertigo (asymmetric SNHL imaging).", front: "Asymmetric SNHL or unilateral tinnitus: what must you exclude?",
      back: "<strong>Vestibular schwannoma</strong> (and other retrocochlear lesions). Get an <strong>MRI with contrast</strong> of the internal auditory canals.<figure class='note-fig' data-credit=\"Vestibular Schwannoma on Contrast-Enhanced Axial MRI. Wikimedia Commons.\"><img class='zoomable' src='assets/img/mc/36a_vestibular_schwannoma_mri_wikimedia.png' alt='Vestibular schwannoma on axial MRI' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Vestibular schwannoma on contrast-enhanced axial MRI.</figcaption></figure>" },
