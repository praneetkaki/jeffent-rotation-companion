    ...
    blocks: [
      ...
      },
      {
        ...
        html:
          ...
          "</ul>" +
          "<p><strong>Mastoidectomy</strong>, surgical removal of the sac and diseased bone, is the definitive treatment; topical/oral antibiotics only quiet secondary infection while the structural problem remains.</p>" + "<figure class='note-fig' data-credit='Cholesteatoma with a large left tympanic-membrane perforation. Wikimedia Commons.'><img class='zoomable' src='assets/img/mc/image44.png' alt='Cholesteatoma, otoscopic view' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Cholesteatoma with a large tympanic-membrane perforation.</figcaption></figure>"
      },
      {
