...
window.JEFFENT.register({
  ...
  cards: [
    ...
    { id:"button-battery-card", tags: ["EM", "clinical"], milestones:["PC1","PC7"], redFlag:true, ukmla:"Ear and nasal discharge", source:"National Capital Poison Center guidance on button battery injuries.", front:"Why is a button battery in the esophagus an hours-scale emergency, and what mitigates injury before removal?",
      back:"Current conducted through moist mucosa generates hydroxide at the negative pole, causing <strong>alkaline liquefactive necrosis</strong> within hours (necrosis can begin within ~15 min, serious injury within ~2 h). An esophageal battery needs <strong>emergent endoscopic removal</strong> (ideally &lt;2 h). Interim mitigation: <strong>honey</strong> 10 mL every 10 min (child &gt;12 months, able to swallow, within 12 h of ingestion, en route) and <strong>sucralfate</strong> 1 g every 10 min in hospital &mdash; these must <strong>NEVER delay removal</strong>. Delayed vascular complications (e.g., aortoenteric fistula) can occur days to weeks later." },
