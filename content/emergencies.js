...
window.JEFFENT.register({
  ...
  version: "0.4.0-draft",
  level: ["core", "sub-I"],
  status: "DRAFT, pending faculty review. v0.2.0: added a depth pass on four genuinely uncovered airway/emergency algorithms, angioedema differential and management (allergic/mast-cell-mediated vs ACE-inhibitor bradykinin-mediated vs hereditary C1-inhibitor deficiency, since 'give epinephrine' doesn't work for two of the three), penetrating neck trauma (zones I-III and the hard-signs-vs-stable-workup decision), inhalational/thermal airway injury (why it gets intubated early, before it looks like it needs it), and a deeper caustic-ingestion algorithm (alkali vs acid injury pattern, endoscopic grading, stricture risk), grounded in WAO hereditary angioedema guidance, ATLS/trauma teaching, and standard emergency otolaryngology teaching; written fresh from guidelines and standard teaching, not derived from any single textbook. v0.3.0: added 5 red-flag teaching cases identified by a coverage audit (Ludwig's angina, orbital compartment syndrome, PTA/RPA/epiglottitis differential, caustic ingestion, hereditary angioedema). v0.4.0: OpenEvidence-verified correction pass (user-reviewed, not faculty sign-off): reframed penetrating neck trauma around the modern \"no-zone\" approach (block, zones anatomy note, hard-signs card); updated button-battery-card and its red flag with honey/sucralfate mitigation and the <2h esophageal removal window; named liposomal amphotericin B as first-line in invasive-fungal-sinusitis-card and its case; added deep-neck-abx-card, adult-epiglottitis-airway-card, and retropharyngeal-abscess-imaging-card; sharpened the SSNHL treatment-window case to the within-7-days nuance. v0.4.1: expanded the airway-triage anatomy note with stridor localization (inspiratory/biphasic/expiratory), voice-quality clues, the cricothyroid-membrane/CICO surgical-airway landmark, and why facial/neck trauma airways fail fast; expanded the danger-triangle anatomy note with a full deep-neck-space table, the retropharyngeal-vs-danger-space distinction, and the Ludwig's/DNM/Lemierre's/carotid-blowout clinical endpoints; converted the zones-of-the-neck diagram from a coded SVG to the same raster figure used in this module's own zones-of-the-neck anatomy note, occluding only the zone numbers; trimmed a stray meta-sentence from the triage table, noted CT as an additional PTA workup option, retitled the angioedema block to \"Angioedema: Key Differentials,\" and reformatted three dense flashcard backs (PTA/RPA/epiglottitis, angioedema differentials, button battery) into scannable lists/paragraphs.",
  facultyReviewer: "",
  curriculumAnchors: [
    ...
    notes: [
      {
        ...
        html: "<figure class='note-fig' data-credit=\"The larynx. OpenStax Anatomy and Physiology, Fig. 23.6, CC BY 4.0.\"><img class='zoomable' src='assets/1024px-2306_The_Larynx.jpg' alt='The larynx' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Landmarks: Cricothyroid membrane surface anatomy for the emergency surgical airway.</figcaption></figure><ul><li>The airway question comes first, before any differential: <strong>is it patent, at risk, or failing right now?</strong></li><li><strong>Signs of impending obstruction</strong>: stridor, drooling or inability to handle secretions, tripod positioning, agitation or lethargy from hypoxia, voice change.</li><li>Securing or protecting the airway (positioning, urgent ENT/anesthesia, sometimes a surgical airway) always comes before definitive diagnosis.</li></ul><figure class='note-fig' data-credit=\"Airway Triage: Signs of Impending Obstruction (Look, Listen, Act). Wikimedia Commons.\"><img class='zoomable' src='assets/img/mc/85_airway_triage_signs_obstruction_wikimedia.png' alt='Airway triage signs' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Airway triage: signs of impending obstruction.</figcaption></figure>" +
          "<p><strong>Stridor localizes the obstruction.</strong> Stridor is turbulent airflow through a narrowed airway, and its timing tells you the level:</p><ul>" +
          ...
          "<li><strong>Biphasic stridor → glottic/subglottic</strong> (fixed narrowing at or just below the cords): present in both phases (e.g. subglottic stenosis, croup, bilateral vocal fold paralysis).</li>" +
          "<li><strong>Expiratory stridor/wheeze → tracheobronchial</strong> (intrathoracic): worse on expiration (e.g. tracheomalacia, a distal foreign body).</li></ul>" +
          "<p>Inspiratory stridor localizes above the cords, biphasic at or below the cords, expiratory below the thoracic inlet. Stridor is a <strong>red flag, not a diagnosis</strong>: never mistake it for asthmatic wheeze, and never send a stridulous patient for a test they must lie flat or be sedated for without airway backup.</p>" +
          "<p><strong>Voice/quality clues to the level</strong>:</p><ul>" +
          "<li><strong>Muffled \"hot potato\" voice</strong> → a supraglottic problem (epiglottitis, peritonsillar abscess); the airway is threatened but the cords still work.</li>" +
          "<li><strong>Hoarse/breathy voice</strong> → a glottic problem (vocal fold pathology).</li>" +
          "<li><strong>Aphonia plus respiratory distress</strong> → complete or near-complete glottic obstruction.</li></ul>" +
          "<p><strong>The surgical-airway landmark and the CICO endpoint.</strong> Every triage pathway ends the same way: if the patient <strong>cannot be intubated and cannot be oxygenated (CICO)</strong>, the rescue is a front-of-neck airway through the <strong>cricothyroid membrane</strong> (the soft depression between the thyroid cartilage above and the cricoid cartilage below).</p><ul>" +
          "<li><strong>Cricothyroid membrane location</strong>: superficial, midline, relatively avascular, and it sits above the thyroid isthmus and the great vessels.</li>" +
          "<li><strong>Finding it, the laryngeal handshake</strong>: stabilize the larynx between thumb and middle finger, walk down from the thyroid notch onto the cricoid, and the membrane is the gap the index finger falls into (tracing upward from the sternal notch improves accuracy when landmarks are hard to feel).</li>" +
          "<li><strong>Cricothyroidotomy vs tracheostomy</strong>: cricothyroidotomy is the emergency front-of-neck airway (fast, high landmark); tracheostomy is the planned/definitive surgical airway. Cricothyroidotomy is generally avoided as the primary airway in young children.</li></ul>" +
          "<p><strong>Mechanisms of acute airway decompensation</strong> in maxillofacial and neck trauma: the airway can be lost even when it looks patent at minute one.</p><ul>" +
          "<li>A posteriorly displaced maxilla (Le Fort) blocks the nasopharynx; a bilateral anterior mandible fracture lets the tongue base fall back (worse supine).</li>" +
          "<li>Blood, secretions, avulsed teeth, and progressive soft-tissue edema/hematoma narrow the lumen over minutes to hours.</li>" +
          "<li>An expanding neck hematoma (e.g. post-thyroidectomy, penetrating neck injury) compresses the airway: sit the patient up, and for a post-op neck, open the wound at the bedside.</li></ul>" +
          "<p><strong>Principle</strong>: in trauma, secure the airway early and electively, before swelling makes intubation impossible; keep a surgical airway ready.</p>"
      },
      {
        title: "The 'danger triangle' of deep-space infection",
        tagline: "Tonsil/dental infection · Carotid sheath · Mediastinum",
        html: "<figure class='note-fig' data-credit='Add figure citation'><img class='zoomable' src='assets/img/figures/cervical_fascia_danger_space.png' alt='Cervical fascia danger space' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Deep cervical fascial spaces communicate (peritonsillar/parapharyngeal/retropharyngeal) and can carry infection down the &#39;danger space&#39; toward the mediastinum.</figcaption></figure><ul><li>Neck and facial infections track along fascial planes into spaces next to the airway, great vessels, and mediastinum.</li><li>The deep neck spaces <strong>communicate</strong> (peritonsillar, parapharyngeal, retropharyngeal, mediastinum).</li><li>This is why a localized infection (quinsy, dental abscess) can escalate to airway compromise, carotid sheath involvement, or descending mediastinitis if not treated promptly.</li><li>Note this is a <strong>different concept</strong> from the \"danger triangle of the face\" (the mid-face region drained by the facial vein, with retrograde spread risking cavernous sinus thrombosis): both are worth knowing, but they are not the same danger triangle.</li></ul>" +
          ...
          "<tr><td><strong>Submandibular / sublingual</strong></td><td>Floor of mouth, split by the mylohyoid</td><td>Communicates posteriorly with the parapharyngeal space</td><td>Odontogenic (lower molars); bilateral spread = Ludwig's angina</td></tr>" +
          "<tr><td><strong>Parapharyngeal (lateral pharyngeal)</strong></td><td>Inverted cone: skull base to hyoid; carotid sheath in its posterior compartment</td><td>Communicates with the retropharyngeal, submandibular, and carotid spaces</td><td>The \"crossroads\": connects nearly every other space; carotid sheath at risk</td></tr>" +
          "<tr><td><strong>Masticator</strong></td><td>Muscles of mastication plus the ramus/body of the mandible</td><td>Communicates with the parapharyngeal space</td><td>Odontogenic; prominent trismus</td></tr>" +
          "<tr><td><strong>Carotid sheath</strong></td><td>Carotid artery, IJV, vagus (CN X)</td><td>Skull base to mediastinum: a direct longitudinal conduit for descending spread</td><td>Erosion → hemorrhage; septic thrombophlebitis (Lemierre's)</td></tr>" +
          "<tr><td><strong>Retropharyngeal</strong></td><td>Buccopharyngeal fascia (anterior) to alar fascia (posterior); midline raphe present</td><td>Skull base to roughly C6-T4, where the alar and buccopharyngeal fascia fuse</td><td>Pediatric (suppurative RP nodes after a URI); anterior route to the mediastinum</td></tr>" +
          "<tr><td><strong>Danger space (space 4)</strong></td><td>Between the alar fascia (anterior) and the prevertebral fascia (posterior); loose areolar tissue, no midline raphe</td><td>Skull base to the diaphragm (posterior mediastinum, retroperitoneum)</td><td>A direct, low-resistance conduit from a localized infection to the chest</td></tr>" +
          "<tr><td><strong>Prevertebral</strong></td><td>Between the prevertebral fascia and the vertebral bodies</td><td>Along the spine</td><td>Vertebral osteomyelitis / spinal source</td></tr>" +
          "<tr><td><strong>Pretracheal (anterior visceral)</strong></td><td>Anterior to the trachea, behind the strap muscles</td><td>Down to the pericardium at the carina</td><td>Anterior route to the anterior mediastinum; airway compression</td></tr>" +
          "</tbody></table></div>" +
          "<p><strong>Retropharyngeal vs. danger space boundaries</strong>:</p><ul>" +
          "<li>The <strong>retropharyngeal space</strong> stops where the alar and buccopharyngeal fascia fuse (roughly C6-T4) and has a <strong>midline raphe</strong> limiting side-to-side spread.</li>" +
          "<li>The <strong>danger space (space 4)</strong> sits just behind it, separated only by the thin alar fascia: <strong>no midline raphe</strong>, running skull base to diaphragm, so infection breaching into it spreads both contralaterally and all the way to the posterior mediastinum.</li>" +
          "<li>That single fascial plane (the alar fascia) is the difference between a contained retropharyngeal abscess and descending necrotizing mediastinitis.</li></ul>" +
          "<p><strong>Clinical complications</strong>:</p><ul>" +
          "<li><strong>Ludwig's angina</strong>: bilateral submandibular/sublingual cellulitis (usually odontogenic) → floor-of-mouth induration, posterior tongue displacement → airway obstruction. Early surgical drainage cuts airway-compromise risk roughly tenfold vs antibiotics alone; secure the airway first.</li>" +
          "<li><strong>Descending necrotizing mediastinitis (DNM)</strong>: about 70% descend via the retropharyngeal/danger space to the posterior mediastinum; reported mortality roughly 10-40%; requires neck and chest CT plus surgical drainage.</li>" +
          "<li><strong>Lemierre's syndrome</strong>: septic thrombophlebitis of the IJV (carotid space), classically <em>Fusobacterium</em> after an oropharyngeal infection → septic pulmonary emboli.</li>" +
          "<li><strong>Carotid artery erosion/blowout</strong>: carotid sheath involvement; a sentinel bleed precedes catastrophic hemorrhage.</li>" +
          "<li>Highest-risk sources are odontogenic (lower molars) and pharyngeal/tonsillar; risk factors for descent are diabetes, immunocompromise, older age, and multispace involvement (especially retropharyngeal plus parapharyngeal).</li></ul>" +
          "<p><strong>Imaging/management anchor</strong>: contrast-enhanced CT neck (extended through the chest if descent is suspected) is the key study, distinguishing a drainable abscess (rim-enhancing collection) from phlegmon and screening the mediastinum. Airway first, then IV broad-spectrum antibiotics covering oral flora (Gram-positive, Gram-negative, anaerobes) plus surgical drainage of any organized collection.</p>"
      },
      {
        title: "Shared anatomic basis of ENT emergencies",
      ...
      },
      {
        ...
        html: "<figure class='note-fig' data-credit='Add figure citation'><img class='zoomable' src='assets/img/figures/neck_zones_trauma.png' alt='Neck zones trauma' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Zones I, II, III of the neck for penetrating trauma and how surgical accessibility differs by zone.</figcaption></figure><p>For <strong>penetrating neck trauma</strong>, the neck is divided into three horizontal zones, not because the anatomy changes character at each boundary, but because <strong>surgical accessibility</strong> does, and that access drives the initial management algorithm (see Clinical tab):</p><ul>" +
          ...
          "<p>The practical point: a Zone II injury is easy to get into and control operatively, so a Zone II patient with hard signs typically goes straight to the OR; Zone I and III injuries are harder to control surgically, so even some hard-sign patients there are worked up with imaging (CT angiography) first to plan the approach, when they are stable enough to allow it. Note on currency: modern trauma practice has shifted to a \"no-zone\" approach: in the stable patient, hard/soft signs plus CT angiography drive management rather than the zone itself. The zones now mainly describe surgical accessibility, not who is explored.</p>"
      }
    ],
    diagrams: [
      {
      ...
      },
      {
        ...
        note: "Same figure used in this module's 'Zones of the neck' anatomy lecture. Only the zone numbers are hidden; the landmark labels (skull base, angle of mandible, cricoid cartilage, clavicle) stay visible on the image. Click a zone number to reveal what defines it.",
  ...
  clinical: {
    blocks: [
      {
        ...
        html: "<p>A rapid-recall table of the classic time-critical presentations across every track.</p>",
        table: {
      ...
      },
      {
        ...
        title: "Angioedema: Key Differentials",
        html: "<p>Sudden lip/tongue/airway swelling <strong>without urticaria or itch</strong> requires determining <strong>whether the mechanism is histamine-mediated at all</strong>. Two of the three major causes of angioedema are <strong>bradykinin-mediated</strong>, not mast-cell/histamine-mediated, and bradykinin-mediated swelling does <strong>not</strong> reliably respond to epinephrine, antihistamines, or steroids, the standard anaphylaxis triad.</p>",
        table: {
      ...
      },
      {
        ...
        title: "Penetrating neck trauma: hard signs go to the OR; the modern approach is \"no-zone\"",
        html: "<p>After the ATLS primary survey (airway/breathing/circulation), the first question is \"<strong>hard signs or not?</strong>\", not \"what zone?\". Hard signs (expanding/pulsatile hematoma, active pulsatile bleeding, bruit/thrill, absent distal pulse, air bubbling from the wound, airway compromise, massive hemoptysis/hematemesis) mandate immediate operative exploration.</p><p>For the stable patient without hard signs, current practice uses a <strong>\"no-zone\" approach</strong>: CT angiography plus serial exam guides management, regardless of which zone the wound is in. This has largely replaced the older rule of \"explore all Zone II, image Zone I and III,\" because the entry-wound zone poorly predicts the actual internal injury and mandatory Zone II exploration produced many negative operations.</p><p>The zones (see Anatomy tab) still matter for <strong>how</strong> the operation is done (surgical access differs), but they no longer decide <strong>who</strong> goes to the OR. That decision is driven by hard signs and imaging.</p>",
        table: {
    ...
    redFlags: [
      ...
      { t: "<b>Button battery in the ear, nose, or (especially) esophagus</b>: an hours-scale emergency due to alkaline liquefactive necrosis. An esophageal battery needs emergent removal (ideally &lt;2 h); give honey (en route, if able to swallow) and sucralfate (in hospital) to mitigate injury, but never let this delay removal." },
  ...
  cases: [
    {
      ...
      teaching: "<figure class='note-fig' data-credit='Add figure citation'><img class='zoomable' src='assets/img/figures/acute_epiglottitis.png' alt='Acute epiglottitis' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Adult epiglottitis presenting with muffled voice/drooling despite a deceptively normal-looking oropharynx, confirmed by flexible laryngoscopy.</figcaption></figure><strong>Clinical Pearl:</strong> Epiglottitis occurs in adults, not only in the pre-vaccine pediatric population. Muffled voice and drooling with a normal-appearing oropharynx warrants airway-first management."
    },
    {
    ...
    },
    {
      ...
      prompts: [
        ...
        { q: "What is the immediate management?", a: "Emergent bedside biopsy for frozen section and surgical debridement of necrotic tissue, plus <strong>IV liposomal amphotericin B</strong> (first-line antifungal) and aggressive correction of the underlying metabolic derangement (DKA); do not wait for formal imaging or cultures to begin acting." }
      ],
      teaching: "<strong>Clinical Pearl:</strong> Black eschar plus facial numbness in a hyperglycemic or immunocompromised patient is a same-hour surgical emergency."
    },
    {
    ...
    },
    {
      ...
      prompts: [
        { q: "Why is this treated with urgency rather than routine referral?", a: "<strong>Sudden sensorineural hearing loss (SSNHL)</strong> has a <strong>time-sensitive treatment window</strong>: corticosteroid benefit is greatest in the first 2 weeks and is minimal after 4-6 weeks; more recent data encourage starting <strong>within 7 days</strong> of onset when possible. Delayed treatment reduces the chance of hearing recovery." },
      ...
      teaching: "<figure class='note-fig' data-credit='Add figure citation'><img class='zoomable' src='assets/img/figures/audiogram_interpretation.png' alt='Audiogram interpretation' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Sudden sensorineural hearing loss confirmed by urgent audiogram, with a time-sensitive steroid treatment window.</figcaption></figure><strong>Clinical Pearl:</strong> Sudden sensorineural hearing loss is a treatment-window emergency; delayed steroid initiation risks permanent hearing loss."
    },
    {
      ...
      teaching: "<strong>Clinical Pearl:</strong> Angioedema unresponsive to epinephrine and antihistamines indicates a bradykinin-mediated mechanism, not treatment-refractory anaphylaxis. Screen for ACE-inhibitor use and family history before repeating the anaphylaxis protocol."
    },
    {
    ...
    },
    {
      ...
      teaching: "<figure class='note-fig' data-credit='Add figure citation'><img class='zoomable' src='assets/img/figures/fascial_layers_neck.png' alt='Fascial layers neck' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Ludwig&#39;s angina: odontogenic bilateral floor-of-mouth/submandibular space cellulitis threatening the airway via tongue displacement.</figcaption></figure><strong>Clinical Pearl:</strong> Ludwig's angina can obstruct the airway via posterior tongue displacement before any drainable collection forms. Early, controlled airway management (awake fiberoptic intubation with surgical airway standby) is indicated rather than observation."
    },
    {
      ...
      teaching: "<strong>Clinical Pearl:</strong> Retrobulbar hemorrhage with proptosis, a tense globe, and decreasing vision (particularly with an RAPD) requires immediate bedside lateral canthotomy and cantholysis, without waiting for imaging."
    },
    {
      ...
      teaching: "<strong>Clinical Pearl:</strong> Peritonsillar abscess, retropharyngeal abscess, and epiglottitis overlap in presentation but diverge in exam findings, diagnostic study, and management. Age and exam pattern (trismus/uvular deviation vs. torticollis in a toddler vs. tripod/drooling/stridor) differentiate them; airway assessment takes priority regardless of diagnosis."
    },
    {
      ...
      teaching: "<strong>Clinical Pearl:</strong> A normal oral exam does not exclude esophageal caustic injury. Do not induce vomiting or attempt neutralization. Endoscopy within 24 hours of stabilization grades injury severity and predicts stricture risk; intentional ingestion also requires psychiatric evaluation."
    },
    {
  ...
  cards: [
    ...
    { id:"adult-epiglottitis-airway-card", tags: ["EM", "clinical"], milestones:["PC1"], redFlag:true, ukmla:"Stridor", source:"Bridwell, Koyfman & Long, Am J Emerg Med, 2022; Felton et al., West J Emerg Med, 2021.", front:"How does airway management of adult epiglottitis differ from the classic pediatric approach?",
      back:"Adults have a larger airway, so most do <strong>NOT</strong> need intubation: a selective approach is used, with airway intervention required in under ~10% of cases. Red flags that predict the need for a secured airway: stridor, drooling, respiratory distress, rapid onset, tachypnea/hypoxia. When intervention is needed, <strong>awake flexible/fiberoptic intubation</strong> (with surgical airway backup) has replaced routine direct laryngoscopy. All patients get IV antibiotics and airway monitoring in a controlled setting." },
    { id:"quinsy-vs-rpa-vs-epiglottitis-card", tags: ["EM", "clinical"], milestones:["PC1","MK1"], redFlag:true, ukmla:"Sore throat", source:"Standard emergency otolaryngology differential teaching.", front:"Differentiate peritonsillar abscess, retropharyngeal abscess, and epiglottitis by key exam clue.",
      back:"<ul><li><strong>Peritonsillar abscess:</strong> uvula deviation, tonsillar bulge, trismus.</li><li><strong>Retropharyngeal abscess:</strong> torticollis, neck stiffness, refusal to extend neck (mostly young children).</li><li><strong>Epiglottitis:</strong> tripod position, drooling, no oropharyngeal exam without airway backup.</li></ul>" },
    { id:"retropharyngeal-abscess-imaging-card", tags: ["EM", "clinical"], milestones:["PC1","MK2"], ukmla:"Sore throat", source:"Darawish et al., Deep Neck Space Infections in Children, Am J Otolaryngol, 2026.", front:"What is the imaging of choice and the surgical threshold for a pediatric retropharyngeal abscess?",
      back:"<strong>Contrast-enhanced CT of the neck</strong> (after airway is assured) is the mainstay: it defines the collection, its relation to the great vessels/mediastinum, and guides drainage. Many cases resolve with IV antibiotics alone; surgical (usually transoral) drainage is indicated for airway compromise, an abscess &gt; ~2-2.5 cm, or failure to improve on antibiotics." },
    ...
    { id:"button-battery-card", tags: ["EM", "clinical"], milestones:["PC1","PC7"], redFlag:true, ukmla:"Ear and nasal discharge", source:"National Capital Poison Center guidance on button battery injuries.", front:"Why is a button battery in the esophagus an hours-scale emergency, and what mitigates injury before removal?",
      back:"<p>Current conducted through moist mucosa generates hydroxide at the negative pole, causing <strong>alkaline liquefactive necrosis</strong> within hours (necrosis can begin within ~15 min, serious injury within ~2 h). An esophageal battery needs <strong>emergent endoscopic removal</strong> (ideally &lt;2 h); delayed vascular complications (e.g., aortoenteric fistula) can occur days to weeks later.</p><p>Interim mitigation: <strong>honey</strong> 10 mL every 10 min (child &gt;12 months, able to swallow, within 12 h of ingestion, en route) and <strong>sucralfate</strong> 1 g every 10 min in hospital: these must <strong>NEVER delay removal</strong>.</p>" },
    ...
    { id:"invasive-fungal-sinusitis-card", tags: ["EM", "clinical"], milestones:["PC1","MK2"], redFlag:true, ukmla:"Facial pain", source:"Standard rhinology teaching on acute invasive fungal sinusitis.", front:"What clinical picture should trigger emergent evaluation for acute invasive fungal sinusitis, and what is first-line treatment?",
      back:"<strong>Diabetic (especially DKA) or immunocompromised patient</strong> with facial pain, nasal congestion, a <strong>black/necrotic eschar</strong> on the septum or palate, and facial numbness. Management is a same-hour triad: <strong>emergent biopsy/frozen section and surgical debridement</strong>, <strong>IV liposomal amphotericin B</strong> (first-line), and aggressive correction of the underlying derangement (e.g., DKA). Delay measured in hours worsens mortality." },
    ...
    { id:"deep-neck-abx-card", tags: ["EM", "pharm"], milestones:["PC1","SBP3"], ukmla:"Sore throat", source:"Bridwell et al., Diagnosis and Management of Ludwig's Angina, Am J Emerg Med, 2021; Eskander, de Almeida & Irish, N Engl J Med, 2019.", front:"What is the empiric antibiotic approach for a deep neck space infection or Ludwig's angina?",
      back:"IV broad-spectrum coverage of oral flora: streptococci, <em>Staphylococcus aureus</em>, and anaerobes: most commonly <strong>ampicillin-sulbactam</strong>. Add <strong>vancomycin</strong> if MRSA risk factors are present. <strong>Clindamycin</strong> is an option in penicillin allergy. Antibiotics support but do not replace airway management and surgical/dental source control." },
    ...
    { id:"angioedema-three-types-card", tags: ["EM", "clinical"], milestones:["PC1","MK2"], redFlag:true, ukmla:"Allergies", source:"Standard emergency/allergy teaching; WAO hereditary angioedema guidance for the bradykinin-mediated framework.", front:"A patient has lip/tongue swelling with no urticaria or itch. What three mechanisms of angioedema should you consider, and which one(s) respond to epinephrine?",
      back:"<ul><li><strong>Allergic/mast-cell-mediated</strong> (histamine): responds to epinephrine/antihistamines/steroids.</li><li><strong>ACE-inhibitor-induced</strong> (bradykinin): does NOT reliably respond.</li><li><strong>Hereditary angioedema (HAE)</strong> from C1-esterase-inhibitor deficiency (bradykinin): does NOT respond.</li></ul><p>Only the allergic type is treated with standard anaphylaxis medications.</p>" },
    ...
    { id:"neck-trauma-hard-signs-card", tags: ["EM", "clinical"], milestones:["PC1"], redFlag:true, ukmla:"Neck lump", source:"ATLS principles; standard trauma teaching on penetrating neck trauma.", front:"In penetrating neck trauma, any hard sign of vascular or aerodigestive injury, such as an expanding hematoma or active pulsatile bleeding, mandates <span class=\"cloze-blank\">[...]</span>, even if the patient looks stable at that moment.",
      back:"In penetrating neck trauma, any hard sign of vascular or aerodigestive injury, such as an expanding hematoma or active pulsatile bleeding, mandates <mark class=\"cloze-answer\">immediate operative exploration</mark>, even if the patient looks stable at that moment. In the stable patient without hard signs, the modern \"no-zone\" approach uses CT angiography plus serial exam to guide management, rather than the entry-wound zone." },
