...
window.JEFFENT.register({
  ...
  anatomy: {
    ...
    diagrams: [
      ...
      },
      {
        ...
        source: "Source not yet cited, added by the project owner, replace credit before sharing.",
        labels: [
  ...
  cases: [
    ...
    },
    {
      ...
      teaching: "<figure class='note-fig' data-credit='Source not yet cited, added by the project owner, replace credit before sharing.'><img class='zoomable' src='assets/img/figures/audiogram_interpretation.png' alt='Audiogram interpretation' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Sudden sensorineural hearing loss confirmed by urgent audiogram, with a time-sensitive steroid treatment window.</figcaption></figure><strong>Clinical Pearl:</strong> Sudden sensorineural hearing loss is a treatment-window emergency; delayed steroid initiation risks permanent hearing loss."
    },
    {
