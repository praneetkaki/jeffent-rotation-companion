...
window.JEFFENT.register({
    ...
    notes: [
      {
        ...
        html: "<figure class='note-fig' data-credit=\"OpenStax, Anatomy and Physiology 2e (Ch. 22). CC BY 4.0.\"><img class='zoomable' src='assets/img/laryngology/larynx-openstax.png' alt='Larynx, anterior and lateral views' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Hyoid, thyroid and cricoid cartilages, epiglottis, arytenoid, vocal and vestibular folds.</figcaption></figure><ul><li><strong>Thyroid cartilage</strong> (the 'Adam's apple') and <strong>cricoid cartilage</strong> (the only complete ring in the airway) form the outer skeleton.</li><li>The paired <strong>arytenoid cartilages</strong> sit on the cricoid and rotate/glide to open and close the vocal folds.</li><li>The <strong>epiglottis</strong> folds over the laryngeal inlet during swallowing to protect the airway.</li></ul>"
      },
      {
        title: "Three subsites: supraglottis, glottis, subglottis",
        html: "<figure class='note-fig' data-credit=\"Coronal larynx. Wikimedia Commons.\"><img class='zoomable' src='assets/img/laryngology/larynx-coronal-wikimedia.png' alt='Coronal larynx' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>False and true vocal folds, laryngeal ventricle, and subglottis.</figcaption></figure><figure class='note-fig' data-credit='Laryngeal subsites. NCI Visuals Online. Public domain.'><img class='zoomable' src='assets/img/laryngology/larynx-subsites-nci.png' alt='Laryngeal subsites' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Laryngeal subsites: supraglottis, glottis, and subglottis.</figcaption></figure><ul><li>The backbone of laryngeal cancer staging and of localizing airway pathology.</li><li><strong>Supraglottis</strong> (epiglottis, false folds, ventricle): rich lymphatics, so cancers present later with neck nodes.</li><li><strong>Glottis</strong> (true vocal folds): sparse lymphatics, so cancer causes hoarseness <em>early</em> and is often caught before it spreads.</li><li><strong>Subglottis</strong> (true folds to cricoid): the narrowest part of a child's airway and the site of subglottic stenosis.</li></ul>"
      },
      {
        title: "Vocal fold layers",
        html: "<figure class='note-fig' data-credit=\"Vocal fold layers (cover-body model). Illustration generated with Google Gemini.\"><img class='zoomable' src='assets/img/mc/image57.png' alt='Vocal fold layers' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Landmarks: Epithelium, superficial lamina propria (Reinke's space), vocal ligament, vocalis muscle.</figcaption></figure><ul><li>The fold is layered: <strong>epithelium</strong>, then the <strong>lamina propria</strong> (superficial 'Reinke's space', intermediate, deep), then the <strong>vocalis muscle</strong>.</li><li>Phonation depends on the epithelium and superficial lamina propria vibrating freely over the deeper layers (the 'cover-body' model).</li><li>Scarring or swelling of Reinke's space (smoking, reflux, vocal abuse) stiffens the cover and roughens the voice.</li></ul><figure class='note-fig' data-credit=\"Microarchitecture of the True Vocal Fold (Cover-Body Layers). Illustration generated with Google Gemini.\"><img class='zoomable' src='assets/img/mc/52_vocal_fold_microarchitecture_gemini.png' alt='Vocal fold microarchitecture' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Microarchitecture of the true vocal fold, cover-body layers.</figcaption></figure>"
      },
      {
        title: "Laryngeal nerve supply",
        html: "<figure class='note-fig' data-credit=\"Laryngeal nerves (superior and recurrent laryngeal). Wikimedia Commons.\"><img class='zoomable' src='assets/img/mc/image58.png' alt='Laryngeal nerves' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Landmarks: Superior laryngeal nerve (internal and external branches) and the recurrent laryngeal nerve.</figcaption></figure><ul><li><strong>Superior laryngeal nerve</strong>: external branch to cricothyroid (pitch); internal branch for sensation above the cords.</li><li><strong>Recurrent laryngeal nerve (RLN)</strong>: every other intrinsic muscle (including the only abductor, posterior cricoarytenoid) and sensation below the cords.</li><li>The RLN is long and asymmetric: <strong>left</strong> loops under the aortic arch, <strong>right</strong> under the subclavian artery.</li><li>That is why hoarseness can be the first sign of a lung apex tumor, aortic aneurysm, or thyroid/mediastinal disease, and why the RLN is at risk in thyroid surgery.</li></ul><figure class='note-fig' data-credit=\"Innervation of the Larynx (SLN and RLN Courses). Wikimedia Commons.\"><img class='zoomable' src='assets/img/mc/53_laryngeal_nerve_supply_wikimedia.png' alt='Laryngeal nerve supply' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Innervation of the larynx: superior and recurrent laryngeal nerve courses.</figcaption></figure>"
      }
    ],
    diagrams: [
      {
        ...
        src: "assets/img/mc/54_laryngeal_cartilage_framework_gemini.png",
      ...
      },
      {
        ...
        src: "assets/img/mc/52_vocal_fold_microarchitecture_gemini.png",
  ...
  clinical: {
    blocks: [
      ...
      },
      {
        ...
        html: "<p><strong>Tube variables:</strong></p>"
          ...
          + "<li>Confirm tolerance before final removal.</li></ol>" + "<figure class='note-fig' data-credit='Tracheostomy tube in place. Wikimedia Commons.'><img class='zoomable' src='assets/img/mc/image63.png' alt='Tracheostomy tube in place' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>A tracheostomy tube seated in the trachea through the stoma.</figcaption></figure><figure class='note-fig' data-credit=\"Tracheostomy Tube Types (Cuffed, Uncuffed, Fenestrated, Dual-Cannula). Wikimedia Commons.\"><img class='zoomable' src='assets/img/mc/57_tracheostomy_tube_types_wikimedia.png' alt='Tracheostomy tube types' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Tracheostomy tube types: cuffed, uncuffed, fenestrated, dual-cannula.</figcaption></figure>"
      }
    ],
    redFlags: [
  ...
  cases: [
    ...
    },
    {
      ...
      teaching: "Onset speed and toxicity separate croup from epiglottitis faster than any single sign."
    },
    {
      ...
      teaching: "Progressive hoarseness + weight loss + tobacco/alcohol is a scope-first presentation, not a 'wait and see.'"
    },
    {
    ...
    },
    {
      ...
      teaching: "In the first postoperative week a tracheostomy stoma is a fresh surgical tract, not an established airway. Treat a dislodged tube as an emergency requiring an alternate airway, not a bedside reinsertion."
    },
    {
  ...
  cards: [
    { id:"laryngeal-cartilages-card", tags: ["LA", "anatomy"], milestones:["MK1","PC6"], ukmla:"Hoarseness and voice change", source:"Standard laryngeal anatomy teaching.", front:"Name the laryngeal cartilages and one key fact about each.",
      back:"<strong>Thyroid</strong> (largest, the 'Adam's apple'), <strong>cricoid</strong> (only <em>complete</em> ring in the airway, critical for cricothyroidotomy landmarks), paired <strong>arytenoids</strong> (rotate/glide to open/close the folds), and the <strong>epiglottis</strong> (protects the airway on swallowing).<figure class='note-fig' data-credit=\"Laryngeal Cartilage Framework (Thyroid, Cricoid, Arytenoids, Epiglottis). Illustration generated with Google Gemini.\"><img class='zoomable' src='assets/img/mc/54_laryngeal_cartilage_framework_gemini.png' alt='Laryngeal cartilage framework' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>The laryngeal cartilage framework.</figcaption></figure>" },
    ...
    { id:"vf-cover-body", tags: ["LA", "anatomy"], milestones:["MK1","PC6"], ukmla:"Hoarseness and voice change", source:"Standard voice-science teaching (cover-body model of phonation).", front:"What is the 'cover-body' model of vocal fold vibration, and why does it matter clinically?",
      back:"The epithelium + superficial lamina propria (Reinke's space) form a flexible 'cover' that vibrates over the deeper 'body' (vocalis muscle). Anything that stiffens or scars this cover, whether smoking, reflux, chronic vocal abuse, or surgery, dampens the mucosal wave and roughens the voice.<figure class='note-fig' data-credit=\"Microarchitecture of the True Vocal Fold (Cover-Body Layers). Illustration generated with Google Gemini.\"><img class='zoomable' src='assets/img/mc/52_vocal_fold_microarchitecture_gemini.png' alt='Vocal fold cover-body layers' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Vocal fold layered microarchitecture.</figcaption></figure>" },
    ...
    { id:"rln-course-card", tags: ["LA", "anatomy"], milestones:["MK1","PC6"], ukmla:"Hoarseness and voice change", source:"Standard laryngeal neuroanatomy teaching.", front:"Trace the course of the recurrent laryngeal nerve on each side, and explain why it matters for hoarseness.",
      back:"<strong>Left RLN</strong> loops under the <strong>aortic arch</strong>; <strong>right RLN</strong> loops under the <strong>subclavian artery</strong>. Both then ascend near the thyroid. This long course means a lung apex tumor, aortic aneurysm, or thyroid/mediastinal mass can present as <strong>hoarseness</strong>, and it's the nerve at risk during thyroid surgery.<figure class='note-fig' data-credit=\"Recurrent Laryngeal Nerve Asymmetric Thoracic and Neck Course. Illustration generated with Google Gemini.\"><img class='zoomable' src='assets/img/mc/55_recurrent_laryngeal_nerve_course_gemini.png' alt='Recurrent laryngeal nerve course' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Recurrent laryngeal nerve asymmetric thoracic and neck course.</figcaption></figure>" },
    ...
    { id:"reinkes-edema-card", tags: ["LA", "clinical"], milestones:["PC6"], ukmla:"Hoarseness and voice change", source:"Standard laryngology teaching on Reinke's edema.", front:"What is Reinke's edema, and what is its classic association?",
      back:"Diffuse, bilateral, gelatinous swelling of the superficial lamina propria (Reinke's space) causing a <strong>low, husky voice</strong>. Classically associated with <strong>chronic smoking</strong>; also reflux and hypothyroidism. Management starts with smoking cessation.<figure class='note-fig' data-credit=\"Reinke's Edema: Bilateral Gelatinous Polypoid Corditis. Wikimedia Commons.\"><img class='zoomable' src='assets/img/mc/58_reinkes_edema_wikimedia.png' alt='Reinke's edema' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Reinke's edema: bilateral gelatinous polypoid corditis.</figcaption></figure>" },
    { id:"vocal-process-granuloma-card", tags: ["LA", "clinical"], milestones:["PC6"], ukmla:"Hoarseness and voice change", source:"Standard laryngology teaching on vocal process (contact) granuloma.", front:"A vocal process (contact) granuloma is a benign inflammatory lesion at the <span class=\"cloze-blank\">[...]</span> of the arytenoid, most often following intubation trauma.",
      back:"A vocal process (contact) granuloma is a benign inflammatory lesion at the <mark class=\"cloze-answer\">vocal process</mark> of the arytenoid, most often following intubation trauma. Surgical excision carries a high recurrence rate unless a driving cause, such as reflux or phonotrauma, is treated first.<figure class='note-fig' data-credit=\"Vocal Process (Contact) Granuloma of the Posterior Glottis. Wikimedia Commons.\"><img class='zoomable' src='assets/img/mc/56_vocal_process_granuloma_wikimedia.png' alt='Vocal process granuloma' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Vocal process (contact) granuloma of the posterior glottis.</figcaption></figure>" },
