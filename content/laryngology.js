...
window.JEFFENT.register({
    ...
    notes: [
      {
        ...
        tagline: "Thyroid, cricoid, and arytenoid cartilages, plus the epiglottis -- the skeleton that opens, closes, and protects the airway.",
      ...
      },
      {
        ...
        tagline: "The subsite map behind laryngeal cancer staging, and why glottic cancer is caught earlier than the other two.",
      ...
      },
      {
        ...
        tagline: "The cover-body microarchitecture that lets the vocal fold vibrate, and what scars it.",
  ...
  clinical: {
    blocks: [
      ...
      },
      {
        ...
        html: "<p>Three main approaches, trading durability against morbidity and voice:</p><ul>" +
          "<li><strong>Endoscopic dilation (ED)</strong> &mdash; least invasive, most common, but highest recurrence (~50% needing repeat surgery at 5 yr).</li>" +
          "<li><strong>Endoscopic resection with adjuvant medical therapy (ERMT)</strong> &mdash; CO&#8322; laser incision + dilation plus adjuvant medical therapy (PPI, inhaled corticosteroid, &plusmn; trimethoprim-sulfamethoxazole); intermediate recurrence (~30% at 5 yr) with minimal voice impact.</li>" +
          "<li><strong>Cricotracheal resection (CTR)</strong> &mdash; open resection, most durable (~5% recurrence at 5 yr) and best breathing/QoL, but greatest perioperative risk and worst long-term voice.</li></ul>" +
    ...
    redFlags: [
      ...
      { t: "<b>Total laryngectomy patient in respiratory distress</b>: these are <b>obligate neck breathers</b> &mdash; there is no connection between the mouth/nose and the trachea. Never attempt oral intubation or bag-mask ventilation via the face; ventilate and intubate through the <b>stoma</b>." }
    ]
  },
