...
window.JEFFENT.register({
  ...
  clinical: {
    blocks: [
      ...
      },
      {
        ...
        html: "<figure class='note-fig' data-credit='Add figure citation'><img class='zoomable' src='assets/img/figures/recurrent_laryngeal_nerve_course_2.png' alt='Recurrent laryngeal nerve course' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Workup of unilateral vocal fold paralysis requires imaging the entire RLN course; management ladder from voice therapy to thyroplasty.</figcaption></figure><p>Once laryngoscopy confirms an immobile fold, image the <strong>entire recurrent laryngeal nerve course</strong>, from skull base to the aortic arch and mediastinum, because a lesion anywhere along that path (lung apex tumor, thyroid mass, mediastinal node, aortic aneurysm) can be the cause, not just the neck.</p>"
      ...
      },
      {
        ...
        html: "<figure class='note-fig' data-credit='Add figure citation'><img class='zoomable' src='assets/img/figures/laryngeal_subsites_supraglottis.png' alt='Laryngeal subsites supraglottis' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Laryngeal cancer risk factors (synergistic tobacco/alcohol) and why subsite lymphatic drainage drives presentation timing.</figcaption></figure><p><strong>Risk factors:</strong> tobacco and alcohol act <strong>synergistically</strong> (not just additively). <strong>Glottic Cancer: Early Presentation</strong>: the true vocal folds have sparse lymphatics, so even a small tumor causes hoarseness before it can spread. Persistent hoarseness therefore warrants laryngoscopy rather than being dismissed. <strong>Supraglottic and subglottic</strong> tumors are more lymphatic-rich or silent, so they tend to present later, with a neck mass or airway symptoms.</p><p><strong>Staging, high-yield overview</strong> (a simplified look at T-stage logic, not full AJCC granularity):</p>",
        table: {
  ...
  cases: [
    ...
    },
    {
      ...
      teaching: "<figure class='note-fig' data-credit='Add figure citation'><img class='zoomable' src='assets/img/figures/acute_epiglottitis.png' alt='Acute epiglottitis' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Differentiating croup from epiglottitis in a young child by onset speed, fever, and toxicity.</figcaption></figure>Onset speed and toxicity separate croup from epiglottitis faster than any single sign."
    },
    {
      ...
      teaching: "<figure class='note-fig' data-credit='Add figure citation'><img class='zoomable' src='assets/img/figures/laryngeal_subsites_supraglottis.png' alt='Laryngeal subsites supraglottis' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Progressive hoarseness with tobacco/alcohol risk factors and weight loss requiring urgent laryngoscopy for laryngeal cancer.</figcaption></figure>Progressive hoarseness + weight loss + tobacco/alcohol is a scope-first presentation, not a 'wait and see.'"
    },
    {
