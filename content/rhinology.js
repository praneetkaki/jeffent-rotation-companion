...
window.JEFFENT.register({
  ...
  version: "0.3.0-draft",
  level: ["core", "sub-I"],
  status: "DRAFT, pending faculty review. v0.2.0: added an allergy/rhinitis depth pass, ARIA classification and step-up therapy for allergic rhinitis, the non-allergic rhinitis mimics (vasomotor, hormonal, drug-induced/rhinitis medicamentosa, NARES, gustatory), skin-prick vs serum-specific IgE testing, antihistamine/decongestant pharmacology, and FESS surgical anatomy variants (concha bullosa, Haller cells, Onodi cells), grounded in ARIA, EPOS 2020, and AAO-HNSF Allergic Rhinitis CPG (2015); written fresh from guidelines and standard rhinology teaching, not derived from any single textbook. v0.2.1: OpenEvidence-verified correction pass (user-reviewed, not faculty sign-off) — updated sinusitis-antibiotics to the 2025 AAO-HNSF Adult Sinusitis Update (amoxicillin now first-line over amoxicillin-clavulanate, with the IDSA disagreement noted); added an invasive-fungal-sinusitis block, card, and red flag; added resorbable-packing guidance for anticoagulated/bleeding-disorder/pediatric patients to the epistaxis ladder, escalation card, and case-posterior-epistaxis.",
  facultyReviewer: "",
  curriculumAnchors: [
    ...
    notes: [
      {
        ...
        tagline: "The shared drainage funnel for three sinuses -- why chronic rhinosinusitis is usually an OMC problem, not a one-sinus problem.",
        html: "<figure class='note-fig' data-credit='Source not yet cited, added by the project owner, replace credit before sharing.'><img class='zoomable' src='assets/img/figures/osteomeatal_complex.png' alt='Osteomeatal complex' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Anatomy of the middle meatus/uncinate process/ethmoid bulla forming the ostiomeatal complex, the shared drainage funnel for frontal, anterior ethmoid, and maxillary sinuses.</figcaption></figure><ul><li>Three turbinates (inferior, middle, superior) overhang three meatuses; the <strong>middle meatus</strong> is the key one.</li><li>The <strong>uncinate process</strong> and <strong>ethmoid bulla</strong> form the <strong>ethmoid infundibulum</strong>, the final common drainage pathway (the <strong>ostiomeatal complex</strong>) for the frontal, anterior ethmoid, and maxillary sinuses.</li><li>Obstruct the OMC (mucosal edema, deviated septum, concha bullosa) and all three sinuses back up, which is why CRS is usually a disease of the OMC, not of one sinus alone.</li></ul>"
      },
      {
        title: "The paranasal sinuses: drainage & danger zones",
        tagline: "Where each sinus drains, and the orbital, skull-base, and cavernous-sinus structures each one borders.",
        html: "<figure class='note-fig' data-credit='Source not yet cited, added by the project owner, replace credit before sharing.'><img class='zoomable' src='assets/img/figures/paranasal_sinus_drainage_danger_zones.png' alt='Paranasal sinus drainage danger zones' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Drainage pathways of frontal/maxillary/ethmoid/sphenoid sinuses and the adjacent danger zones (orbit, skull base, cavernous sinus).</figcaption></figure><ul><li><strong>Frontal:</strong> drains via the frontal recess into the middle meatus; borders the anterior cranial fossa.</li>" +
          ...
          "<li><strong>Sphenoid:</strong> drains via the sphenoethmoidal recess; borders the <strong>optic nerve, carotid artery, cavernous sinus, and pituitary</strong>, making it the highest-stakes sinus surgically.</li></ul>"
      },
      {
        title: "Blood supply of the nose",
        tagline: "The four-vessel convergence behind 90% of nosebleeds, and why posterior bleeds are a different problem entirely.",
        html: "<figure class='note-fig' data-credit='Source not yet cited, added by the project owner, replace credit before sharing.'><img class='zoomable' src='assets/img/figures/kiesselbach_plexus.png' alt='Kiesselbach plexus' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Little&#39;s area/Kiesselbach&#39;s plexus vascular convergence and anterior vs posterior epistaxis sources.</figcaption></figure><ul><li><strong>Little's area (Kiesselbach's plexus)</strong> on the anterior septum is where four vessels converge: <strong>anterior ethmoidal</strong> (internal carotid to ophthalmic), <strong>sphenopalatine</strong> and <strong>greater palatine</strong> (external carotid to maxillary), and <strong>superior labial</strong> (external carotid to facial).</li><li>Over 90% of nosebleeds are anterior, from this plexus.</li><li>Posterior bleeds come from the <strong>sphenopalatine artery</strong> itself: heavier, harder to see, and more likely in older or anticoagulated patients.</li></ul>"
      },
      {
        title: "The nasal septum",
        tagline: "Cartilage and bone that make up the septum, and why an undrained septal hematoma is a same-day emergency.",
        html: "<figure class='note-fig' data-credit='Source not yet cited, added by the project owner, replace credit before sharing.'><img class='zoomable' src='assets/img/figures/nasal-septum-openstax.png' alt='Nasal septum openstax' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Septal skeleton (quadrangular cartilage, perpendicular plate of ethmoid, vomer) and septal hematoma risk.</figcaption></figure><ul><li>Cartilage anteriorly (<strong>quadrangular cartilage</strong>); bone posteriorly (<strong>perpendicular plate of the ethmoid</strong> above, <strong>vomer</strong> below).</li><li>Deviation is very common and often asymptomatic.</li><li>A <strong>septal hematoma or abscess</strong> is an emergency: the cartilage has no blood supply of its own and depends entirely on the overlying mucoperichondrium.</li></ul>"
      },
      {
        title: "FESS anatomy variants",
        tagline: "Concha bullosa, Haller cells, and Onodi cells -- the three pneumatization variants every preop sinus CT should be read for.",
        html: "<figure class='note-fig' data-credit='Source not yet cited, added by the project owner, replace credit before sharing.'><img class='zoomable' src='assets/img/figures/FESS_anatomy_variants_sinus_CT.png' alt='FESS anatomy variants sinus CT' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Pneumatization variants relevant to FESS: concha bullosa, Haller cells, Onodi cells.</figcaption></figure><p>Three pneumatization variants that every surgeon (and every student reading a preop sinus CT) should be able to name:</p><ul>" +
          ...
          "<p>None of these are diseases on their own. They matter because they change where the danger is on the CT, which is why every preop sinus CT is read systematically before a scope ever goes in.</p>"
      }
    ],
    diagrams: [
      {
    ...
    blocks: [
      {
        ...
        html: "<figure class='note-fig' data-credit='Source not yet cited, added by the project owner, replace credit before sharing.'><img class='zoomable' src='assets/img/figures/chronic_rhinosinusitis.png' alt='Chronic rhinosinusitis' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Formal CRS definition and CRSsNP/CRSwNP/AERD subtypes with first-line management.</figcaption></figure><p><strong>≥12 weeks</strong> of ≥2 of: nasal obstruction, discharge, facial pain/pressure, or reduced smell, confirmed by nasal endoscopy or CT.</p>",
        table: {
          head: ["Subtype", "Key feature", "First-line management", "Second-line / refractory"],
          rows: [
            ["CRS <b>without</b> polyps (CRSsNP)", "Mucosal thickening, no polyps", "Saline irrigation + intranasal corticosteroid", "Culture-directed oral antibiotics for an acute exacerbation; <strong>FESS</strong> if anatomic obstruction persists despite maximal medical therapy"],
            ["CRS <b>with</b> polyps (CRSwNP)", "Bilateral polyps on endoscopy", "Intranasal/short oral steroid; biologics or FESS if refractory", "<strong>Biologic therapy</strong> (e.g., anti-IL-4/13 such as dupilumab, or anti-IgE) for refractory type-2 inflammation; <strong>revision FESS</strong> if polyps recur despite medical therapy"],
            ["AERD (Samter's triad)", "CRSwNP + asthma + ASA/NSAID sensitivity", "Steroids, leukotriene modifiers, consider aspirin desensitization", "Supervised <strong>aspirin desensitization</strong> if not already tried; <strong>biologics</strong> (e.g., dupilumab) or <strong>revision FESS</strong> for disease refractory to desensitization"]
          ]
        }
      },
      {
        ...
        html: "<p>The old \"seasonal vs perennial\" split has been replaced by <strong>ARIA</strong> (Allergic Rhinitis and its Impact on Asthma), which classifies by <strong>duration</strong> and <strong>severity</strong>, and this is what actually drives step-up therapy.</p><figure class='note-fig' data-credit='Source not yet cited, added by the project owner, replace credit before sharing.'><img class='zoomable' src='assets/img/figures/ARIA_allergic_rhinitis_management.png' alt='ARIA allergic rhinitis management' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>ARIA&#39;s duration/severity classification grid for allergic rhinitis.</figcaption></figure>",
        table: {
      ...
      },
      {
        ...
        html: "<ol><li><strong>Allergen avoidance</strong> + as-needed second-generation oral or intranasal antihistamine for mild/intermittent disease.</li>" +
          ...
          "<li><strong>Refractory disease:</strong> refer for <strong>allergen immunotherapy</strong> &mdash; <strong>SCIT</strong> (subcutaneous immunotherapy) or <strong>SLIT</strong> (sublingual immunotherapy) &mdash; the only disease-modifying option.</li></ol>" + "<figure class='note-fig' data-credit='Source not yet cited, added by the project owner, replace credit before sharing.'><img class='zoomable' src='assets/img/figures/ARIA_allergic_rhinitis_stepwise.png' alt='ARIA allergic rhinitis stepwise' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Stepwise escalation of allergic rhinitis therapy from avoidance through immunotherapy.</figcaption></figure>"
      },
      {
        ...
        table: {
          head: ["Subtype", "Trigger / clue", "Basic management"],
          rows: [
            ["Vasomotor rhinitis", "Temperature change, strong odors, alcohol, emotional stress", "Diagnosis of exclusion; intranasal antihistamine or intranasal ipratropium plus trigger avoidance &mdash; oral antihistamines target histamine, not the mechanism here, so they're less effective"],
            ...
            ["NARES (non-allergic rhinitis with eosinophilia syndrome)", "Nasal smear shows eosinophilia; skin/IgE testing negative", "Intranasal corticosteroids &mdash; often responds well despite the negative allergy workup"],
      ...
      },
      {
        ...
        html: "<p><strong>Testing (used to confirm allergic vs non-allergic rhinitis and identify triggers for avoidance/immunotherapy):</strong></p>" +
          ...
          "<li><strong>Serum-specific IgE testing:</strong> no need to stop antihistamines, safer in patients with extensive eczema/dermatographism or a high anaphylaxis risk, but slower to result and generally slightly less sensitive.</li></ul>" +
      ...
      },
      {
        ...
        html: "<ol><li><strong>First aid:</strong> lean forward, firm pressure on the cartilaginous nose 10-15 min, ± topical vasoconstrictor/tranexamic acid.</li>" +
          ...
          "<li><strong>Anterior nasal packing</strong> (absorbable or non-absorbable) &mdash; prefer <strong>resorbable packing</strong> in patients on anticoagulants/antiplatelets, with bleeding disorders, or in young children.</li>" +
          ...
          "<p>Always check anticoagulation status and reverse if supratherapeutic; consider <strong>HHT</strong> in recurrent bilateral bleeders with a family history and telangiectasias.</p>" +
          "<p>Posterior packs need inpatient admission with cardiac/airway monitoring because the pack can trigger the <strong>nasopulmonary (nasocardiac) vagal reflex</strong> &mdash; bradycardia and hypotension &mdash; and the pack itself carries aspiration and airway-obstruction risk, especially in older patients.</p>" + "<div class=\"fig-row\"><figure class='note-fig' data-credit='Source not yet cited, added by the project owner, replace credit before sharing.'><img class='zoomable' src='assets/img/figures/epistaxis_mgmt.png' alt='Epistaxis mgmt' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Stepwise epistaxis management from first aid through cautery, packing, and arterial ligation/embolization.</figcaption></figure></div>"
      },
      {
        ...
        html: "<ul><li><strong>Adolescent male</strong> + recurrent unilateral epistaxis + nasal mass → <strong>juvenile nasopharyngeal angiofibroma (JNA)</strong>. Highly vascular, so biopsy in clinic is contraindicated.</li>" +
          ...
          "<li><strong>Older adult</strong> + unilateral mass + anosmia/epistaxis → consider <strong>esthesioneuroblastoma</strong> (olfactory groove) or other sinonasal malignancy.</li></ul>" + "<figure class='note-fig' data-credit='Source not yet cited, added by the project owner, replace credit before sharing.'><img class='zoomable' src='assets/img/figures/unilateral_sinonasal_masses.png' alt='Unilateral sinonasal masses' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Age-based pattern for unilateral sinonasal masses: JNA, inverted papilloma, esthesioneuroblastoma/malignancy.</figcaption></figure>"
      },
      {
        id: "fess-complications",
        title: "FESS: the three complication sites every student should know",
        html: "<figure class='note-fig' data-credit='Source not yet cited, added by the project owner, replace credit before sharing.'><img class='zoomable' src='assets/img/figures/paranasal_sinus_drainage_danger_zones.png' alt='Paranasal sinus drainage danger zones' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Three FESS complication sites: orbit (lamina papyracea), skull base (cribriform plate), and internal carotid artery.</figcaption></figure><p>Endoscopic sinus surgery works through thin bone next to three critical structures:</p><ul>" +
      ...
      {
        id: "invasive-fungal-sinusitis",
        title: "Acute invasive fungal rhinosinusitis: the can't-miss emergency",
        html: "<p><strong>Fungal sinus disease spans a spectrum, and host immune status is what separates the emergency from the chronic nuisance:</strong></p><ul>" +
          "<li><strong>Allergic fungal rhinosinusitis (AFRS):</strong> a hypersensitivity reaction to fungi (not true infection) in an <strong>immunocompetent, atopic</strong> patient. Presents as chronic polypoid CRS with thick allergic mucin; not urgent, managed like refractory CRSwNP (steroids, surgery to clear the mucin).</li>" +
          "<li><strong>Fungal ball (mycetoma):</strong> a noninvasive mass of fungal debris colonizing a single sinus (usually maxillary) in an <strong>immunocompetent</strong> patient. Presents as chronic unilateral sinus pressure/discharge, often found incidentally on CT; not urgent, curative with surgical removal alone (no antifungals needed).</li>" +
          "<li><strong>Acute invasive fungal rhinosinusitis:</strong> true angioinvasive infection in an <strong>immunocompromised</strong> host, covered in detail below. This is the only one of the three that is a surgical emergency.</li></ul>" +
          "<p>A <strong>rapidly progressive (&lt;4 weeks), angioinvasive</strong> fungal infection of the sinuses in immunocompromised patients: poorly controlled diabetes (classically DKA), neutropenia, hematologic malignancy, transplant, or chronic high-dose steroids. Mortality is high (roughly 50%, higher with intracranial spread).</p><ul>" +
          "<li><strong>Organisms:</strong> Mucorales (mucormycosis) &mdash; classic in diabetic ketoacidosis &mdash; and Aspergillus.</li>" +
          "<li><strong>Exam:</strong> facial pain/numbness, fever, nasal congestion; endoscopy shows <strong>pale, insensate, or necrotic (black) mucosa/eschar</strong> on the turbinates or palate. Facial numbness and cranial neuropathies signal angioinvasive spread.</li>" +
          "<li><strong>Imaging:</strong> <strong>MRI is most sensitive</strong> (loss of contrast enhancement / \"black turbinate\" sign, perineural and early extrasinus spread); CT complements it for bony/surgical detail. Note ~40% have minimal or normal CT findings early &mdash; a normal CT does not exclude it.</li>" +
          "<li><strong>Diagnosis:</strong> urgent nasal endoscopy with biopsy (frozen section can confirm tissue invasion within ~30 min).</li>" +
          "<li><strong>Management</strong> (all three, urgently): (1) reverse immunosuppression / correct the underlying condition (e.g., treat DKA), (2) immediate systemic antifungals &mdash; <strong>liposomal amphotericin B</strong> for Mucorales, <strong>voriconazole</strong> for Aspergillus, and (3) urgent surgical debridement. This is a <strong>same-day surgical emergency</strong>, not a drops-and-observe problem.</li></ul>"
      }
    ],
    redFlags: [
      { t: "<b>Immunocompromised/diabetic (DKA) patient with facial pain, numbness, or a necrotic nasal/palatal eschar</b>: acute invasive fungal rhinosinusitis (mucormycosis/Aspergillus); urgent endoscopy + biopsy, MRI, systemic antifungals, and surgical debridement." },
  ...
  cases: [
    {
      ...
      prompts: [
        ...
        { q: "Next steps?", a: "Posterior packing or a balloon device, admission for airway/vagal monitoring, ENT involvement, and consideration of endoscopic sphenopalatine artery ligation or embolization if it persists. Assess whether anticoagulation needs to be held/reversed with the prescribing team. If packing is needed in this anticoagulated patient, <strong>resorbable packing is preferred over nonresorbable</strong>, since removing a nonresorbable pack can abrade mucosa and provoke rebleeding (AAO-HNS 2020)." }
      ],
      teaching: "When anterior measures fail and blood tracks posteriorly, escalate the ladder. Don't keep repeating anterior pressure.<figure class='note-fig' data-credit='Source not yet cited, added by the project owner, replace credit before sharing.'><img class='zoomable' src='assets/img/figures/epistaxis_mgmt.png' alt='Epistaxis mgmt' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Posterior epistaxis in an anticoagulated elderly patient, requiring escalation past anterior measures.</figcaption></figure>"
    },
    {
      id: "case-aerd",
    ...
    },
    {
      ...
      prompts: [
        ...
        { q: "Management?", a: "IV antibiotics and urgent <b>surgical drainage</b> (often endoscopic) are typically required for a subperiosteal abscess, especially with limited eye movement or visual change. This is not managed with antibiotics alone. Empiric IV coverage is typically broad-spectrum until culture data return &mdash; e.g., <strong>vancomycin</strong> (MRSA/streptococcal coverage) plus <strong>ceftriaxone</strong> or <strong>ampicillin-sulbactam</strong> (gram-negative and anaerobic coverage) &mdash; then narrowed based on intraoperative culture and sensitivity results." }
      ],
      teaching: "<figure class='note-fig' data-credit='Source not yet cited, added by the project owner, replace credit before sharing.'><img class='zoomable' src='assets/img/figures/acute_sinusitis_complications.png' alt='Acute sinusitis complications' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Subperiosteal orbital abscess as a Chandler stage III complication of pediatric sinusitis.</figcaption></figure>Once there's a discrete collection and limited eye movement, this has moved from 'watch on antibiotics' to 'drain it.'"
    },
    {
      id: "case-csf-leak",
  ...
  cards: [
    ...
    { id:"epistaxis-escalation-card", tags: ["RH", "clinical"], milestones:["PC5","PC1"], ukmla:"Epistaxis", source:"AAO-HNSF Nosebleed CPG, 2020.", front:"List the epistaxis escalation ladder from first aid to refractory management.",
      back:"1) Firm anterior pressure ± vasoconstrictor/tranexamic acid → 2) <strong>cautery</strong> of a visible point → 3) <strong>anterior packing</strong> (prefer resorbable in patients on anticoagulants/antiplatelets, with bleeding disorders, or in young children) → 4) <strong>posterior packing</strong>/balloon + admission if posterior → 5) <strong>sphenopalatine artery ligation</strong> or <strong>embolization</strong> if refractory." },
    ...
    { id:"invasive-fungal-sinusitis-card", tags: ["RH", "clinical"], milestones:["PC5","SBP1"], redFlag:true, ukmla:"Rhinosinusitis", source:"Standard rhinology teaching on acute invasive fungal rhinosinusitis.", front:"In a diabetic (especially DKA) or immunocompromised patient with facial pain and a necrotic \"black\" eschar on the turbinate or palate, the can't-miss diagnosis is <span class=\"cloze-blank\">[...]</span>.",
      back:"In a diabetic (especially DKA) or immunocompromised patient with facial pain and a necrotic \"black\" eschar on the turbinate or palate, the can't-miss diagnosis is <mark class=\"cloze-answer\">acute invasive fungal rhinosinusitis</mark> (mucormycosis from Mucorales, or Aspergillus). It is a surgical emergency requiring urgent biopsy, systemic antifungals (liposomal amphotericin B for Mucorales), surgical debridement, and reversal of immunosuppression. MRI is most sensitive; a normal CT does not exclude it." },
    ...
    { id:"allergic-rhinitis-immunotherapy", tags: ["RH", "clinical"], milestones:["MK2","PC5"], ukmla:"Allergies", source:"AAO-HNSF Clinical Practice Guideline: Allergic Rhinitis, 2015.", front:"When is immunotherapy considered for allergic rhinitis, and what are the two delivery routes?",
      back:"Considered when symptoms are refractory to allergen avoidance + intranasal steroids/antihistamines, or when the patient wants a disease-modifying (not just symptomatic) option. <strong>SCIT</strong> (subcutaneous immunotherapy) and <strong>SLIT</strong> (sublingual immunotherapy) are the two routes; both require specialist allergy/ENT involvement.<br><br><em>Common agents:</em> SCIT typically uses individualized mixes of standardized aeroallergen extracts (dust mite, grass/tree/weed pollens, animal dander, mold) based on the patient's test results. SLIT in the US is most often a once-daily FDA-approved sublingual tablet for a single allergen (e.g., timothy grass, ragweed, or dust mite)." },
    { id:"sinusitis-antibiotics", tags: ["RH", "pharm"], milestones:["SBP3","PC5"], ukmla:"Rhinosinusitis", source:"AAO-HNSF Adult Sinusitis Update, 2025; IDSA Acute Bacterial Rhinosinusitis Guideline, 2012.", front:"Because most acute rhinosinusitis is viral, antibiotics are reserved for symptoms lasting more than <span class=\"cloze-blank\">[...]</span> without improvement, or for severe or worsening symptoms.",
      back:"Because most acute rhinosinusitis is viral, antibiotics are reserved for symptoms lasting more than <mark class=\"cloze-answer\">10 days</mark> without improvement, or for severe or worsening symptoms (\"double worsening\"). First-line therapy in the US is now <strong>amoxicillin</strong> (500 mg tid or 875 mg bid) rather than amoxicillin-clavulanate, per the <strong>2025 AAO-HNSF update</strong>: comparative studies show no better efficacy but more adverse events with clavulanate. Reserve <strong>amoxicillin-clavulanate</strong> (or high-dose 2 g/125 mg bid) for higher-risk patients: age &gt;65, recent antibiotics or hospitalization, immunocompromise, severe disease, frontal/sphenoid involvement, or high local penicillin-resistant pneumococcus rates. <em>(Note: IDSA still weakly favors amoxicillin-clavulanate first-line &mdash; a genuine guideline disagreement.)</em>" }
  ]
});
