  ...
  clinical: {
    blocks: [
      ...
      },
      {
        ...
        html: "<p>The old \"seasonal vs perennial\" split has been replaced by <strong>ARIA</strong> (Allergic Rhinitis and its Impact on Asthma), which classifies by <strong>duration</strong> and <strong>severity</strong>, and this is what actually drives step-up therapy.</p><figure class='note-fig' data-credit='Add figure citation'><img class='zoomable' src='assets/img/figures/ARIA_allergic_rhinitis_management.png' alt='ARIA allergic rhinitis management' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>ARIA&#39;s duration/severity classification grid for allergic rhinitis.</figcaption></figure>",
        table: {
      ...
      },
      {
        ...
        html: "<ol><li><strong>Allergen avoidance</strong> + as-needed second-generation oral or intranasal antihistamine for mild/intermittent disease.</li>" +
          ...
          "<li><strong>Refractory disease:</strong> refer for <strong>allergen immunotherapy</strong>, either <strong>SCIT</strong> (subcutaneous immunotherapy) or <strong>SLIT</strong> (sublingual immunotherapy), the only disease-modifying option.</li></ol>" + "<figure class='note-fig' data-credit='Add figure citation'><img class='zoomable' src='assets/img/figures/ARIA_allergic_rhinitis_stepwise.png' alt='ARIA allergic rhinitis stepwise' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Stepwise escalation of allergic rhinitis therapy from avoidance through immunotherapy.</figcaption></figure>"
      },
      {
      ...
      },
      {
        ...
        html: "<ul><li><strong>Adolescent male</strong> + recurrent unilateral epistaxis + nasal mass → <strong>juvenile nasopharyngeal angiofibroma (JNA)</strong>. Highly vascular, so biopsy in clinic is contraindicated.</li>" +
          ...
          "<li><strong>Older adult</strong> + unilateral mass + anosmia/epistaxis → consider <strong>esthesioneuroblastoma</strong> (olfactory groove) or other sinonasal malignancy.</li></ul>" + "<figure class='note-fig' data-credit='Add figure citation'><img class='zoomable' src='assets/img/figures/unilateral_sinonasal_masses.png' alt='Unilateral sinonasal masses' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Age-based pattern for unilateral sinonasal masses: JNA, inverted papilloma, esthesioneuroblastoma/malignancy.</figcaption></figure>"
      },
      {
  ...
  cases: [
    {
      ...
      teaching: "When anterior measures fail and blood tracks posteriorly, escalate the ladder. Don't keep repeating anterior pressure.<figure class='note-fig' data-credit='Add figure citation'><img class='zoomable' src='assets/img/figures/epistaxis_mgmt.png' alt='Epistaxis mgmt' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Posterior epistaxis in an anticoagulated elderly patient, requiring escalation past anterior measures.</figcaption></figure>"
    },
    {
      id: "case-aerd",
