  ...
  clinical: {
    blocks: [
      ...
      },
      {
        ...
        html: "<p>The old \"seasonal vs perennial\" split has been replaced by <strong>ARIA</strong> (Allergic Rhinitis and its Impact on Asthma), which classifies by <strong>duration</strong> and <strong>severity</strong>, and this is what actually drives step-up therapy.</p><figure class='note-fig' data-credit=\"ARIA Classification for Allergic Rhinitis (Duration and Severity Grid). Illustration generated with Google Gemini.\"><img class='zoomable' src='assets/img/mc/image51.png' alt='ARIA classification grid' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>ARIA classification for allergic rhinitis: duration and severity.</figcaption></figure>",
        table: {
  ...
  cases: [
    {
      ...
      teaching: "When anterior measures fail and blood tracks posteriorly, escalate the ladder. Don't keep repeating anterior pressure.<figure class='note-fig' data-credit=\"Escalation Steps for Posterior/Refractory Epistaxis. Illustration generated with Google Gemini.\"><img class='zoomable' src='assets/img/mc/image53.png' alt='Posterior epistaxis escalation steps' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Escalation steps for posterior or refractory epistaxis.</figcaption></figure>"
    },
    {
      id: "case-aerd",
