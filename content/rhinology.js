    ...
    blocks: [
      ...
      },
      {
        ...
        html: "<ol><li><strong>First aid:</strong> lean forward, firm pressure on the cartilaginous nose 10-15 min, ± topical vasoconstrictor/tranexamic acid.</li>" +
          ...
          "<li><strong>Anterior nasal packing</strong> (absorbable or non-absorbable): prefer <strong>resorbable packing</strong> in patients on anticoagulants/antiplatelets, with bleeding disorders, or in young children.</li>" +
      ...
      },
      {
        ...
        html: "<p><strong>Fungal sinus disease spans a spectrum, and host immune status is what separates the emergency from the chronic nuisance:</strong></p><ul>" +
          ...
          "<li><strong>Organisms:</strong> Mucorales (mucormycosis, classic in diabetic ketoacidosis) and Aspergillus.</li>" +
          ...
          "<li><strong>Imaging:</strong> <strong>MRI is most sensitive</strong> (loss of contrast enhancement / \"black turbinate\" sign, perineural and early extrasinus spread); CT complements it for bony/surgical detail. Note ~40% have minimal or normal CT findings early: a normal CT does not exclude it.</li>" +
          ...
          "<li><strong>Management</strong> (all three, urgently): (1) reverse immunosuppression / correct the underlying condition (e.g., treat DKA), (2) immediate systemic antifungals: <strong>liposomal amphotericin B</strong> for Mucorales, <strong>voriconazole</strong> for Aspergillus, and (3) urgent surgical debridement. This is a <strong>same-day surgical emergency</strong>, not a drops-and-observe problem.</li></ul>"
      }
    ],
    redFlags: [
