...
window.JEFFENT.register({
    ...
    notes: [
      {
        ...
        html: "<p>The <strong>neck levels</strong> are a standardized map of the neck's lymph node basins (the Robbins classification). Head & neck cancers spread in fairly predictable nodal patterns depending on the primary site, so the levels give surgeons, radiologists, and pathologists a common language for describing where nodal disease is, staging it (the N in TNM), and planning exactly which basins a neck dissection needs to cover.</p><figure class='note-fig' data-credit='Add figure citation'><img class='zoomable' src='assets/img/figures/neck_levels_colored.png' alt='Neck levels colored' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Cervical lymph node level classification (I-VII, including IIA/IIB and VA/VB) for head & neck cancer staging.</figcaption></figure><ul><li>Beyond levels I-VI, add <strong>level VII</strong> (superior mediastinal nodes, below the sternal notch), which matters for thyroid and lower-neck cancer staging.</li><li>Level II is often split into <strong>IIA/IIB</strong> by the spinal accessory nerve, and level V into <strong>VA/VB</strong>.</li></ul>" + "<p><strong>Cervical nodal levels (Robbins classification), with surgical boundaries:</strong></p><div class='tbl-scroll'><table><thead><tr><th>Level</th><th>Superior</th><th>Inferior</th><th>Anterior</th><th>Posterior</th><th>Main nodal contents</th><th>Primary drainage</th><th>Structures to watch</th></tr></thead><tbody>" +
          ...
          "<tr><td><strong>IIa / IIb</strong> (upper jugular)</td><td>Skull base</td><td>Hyoid bone (inferior border of hyoid)</td><td>Stylohyoid muscle</td><td>Posterior border of sternocleidomastoid</td><td>Upper deep cervical nodes</td><td>Oral cavity, nasopharynx, oropharynx, larynx, parotid</td><td><strong>Spinal accessory nerve (CN XI)</strong> divides IIa from IIb; internal jugular vein</td></tr>" +
          "<tr><td><strong>III</strong> (mid jugular)</td><td>Hyoid bone</td><td>Inferior border of cricoid cartilage</td><td>Lateral border of sternohyoid</td><td>Posterior border of sternocleidomastoid</td><td>Middle deep cervical nodes</td><td>Larynx, hypopharynx, oropharynx</td><td>Internal jugular vein, ansa cervicalis</td></tr>" +
          "<tr><td><strong>IV</strong> (lower jugular)</td><td>Inferior border of cricoid cartilage</td><td>Clavicle</td><td>Lateral border of sternohyoid</td><td>Posterior border of sternocleidomastoid</td><td>Lower deep cervical nodes</td><td>Larynx, thyroid, hypopharynx, cervical esophagus</td><td><strong>Thoracic duct</strong> (left side); phrenic nerve on scalenus anterior</td></tr>" +
          "<tr><td><strong>Va / Vb</strong> (posterior triangle)</td><td>Convergence of sternocleidomastoid and trapezius</td><td>Clavicle</td><td>Posterior border of sternocleidomastoid</td><td>Anterior border of trapezius</td><td>Spinal accessory and transverse cervical nodes</td><td>Nasopharynx, posterior scalp and neck, thyroid</td><td><strong>Spinal accessory nerve (CN XI)</strong> runs through this level; brachial plexus</td></tr>" +
          "<tr><td><strong>VI</strong> (central compartment)</td><td>Hyoid bone</td><td>Sternal notch (suprasternal notch)</td><td>Common carotid artery (right) / carotid sheath (left)</td><td>Common carotid artery (left) / carotid sheath (right)</td><td>Pretracheal, paratracheal, prelaryngeal (Delphian) nodes</td><td>Thyroid, glottic and subglottic larynx, hypopharynx, cervical esophagus</td><td><strong>Recurrent laryngeal nerve</strong> and <strong>parathyroid glands</strong></td></tr>" +
          "<tr><td><strong>VII</strong> (superior mediastinal)</td><td>Sternal notch</td><td>Innominate artery</td><td>Sternum</td><td>Trachea</td><td>Superior mediastinal nodes</td><td>Thyroid, cervical esophagus</td><td><strong>Thoracic duct</strong> (left side), great vessels</td></tr>" +
          "</tbody></table></div>" +
          "<p><strong>Which levels are dissected together depends on the primary site:</strong></p><ul><li><strong>Supraomohyoid neck dissection</strong> (levels I-III): for <strong>oral cavity</strong> primaries.</li><li><strong>Lateral neck dissection</strong> (levels II-IV): for <strong>oropharynx, larynx, and hypopharynx</strong> primaries.</li><li><strong>Posterolateral neck dissection</strong> (levels II-V): for <strong>skin/scalp</strong> primaries (e.g., melanoma) or other posteriorly draining primaries.</li><li><strong>Central (level VI) dissection</strong>: for <strong>thyroid cancer</strong>.</li></ul>"
      },
      {
        title: "The salivary glands",
        tagline: "Parotid · Submandibular · Sublingual glands",
        html: "<figure class='note-fig' data-credit='Add figure citation'><img class='zoomable' src='assets/img/figures/salivary-glands-openstax.png' alt='Salivary glands openstax' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Major salivary gland anatomy: parotid (Stensen&#39;s duct) and submandibular (Wharton&#39;s duct).</figcaption></figure><ul><li><strong>Parotid</strong>: the largest gland; the <strong>facial nerve</strong> runs through it, dividing it into superficial and deep lobes, so facial-nerve function must be documented before and after any parotid surgery. Duct: <strong>Stensen's</strong>, opens opposite the upper second molar.</li><li><strong>Submandibular</strong>: duct is <strong>Wharton's</strong>, opening at the sublingual caruncle; its uphill course makes it the classic site for salivary stones (sialolithiasis).</li><li><strong>Sublingual</strong>: the smallest major gland, sitting in the floor of the mouth; drains via multiple small ducts (ducts of Rivinus) near the sublingual caruncle rather than one dominant duct.</li></ul>" +
          ...
          "<tr><td><strong>Submandibular</strong></td><td>Submandibular triangle, below the body of the mandible</td><td>Mixed, mucous-predominant</td><td>Wharton's duct runs an uphill course; accounts for the large majority of salivary stones</td></tr>" +
          "<tr><td><strong>Sublingual</strong></td><td>Floor of mouth, anterior to the submandibular gland</td><td>Mucous-predominant</td><td>Smallest major gland; tumors here are rare but disproportionately likely to be malignant when they occur</td></tr>" +
          "</tbody></table></div>" +
          "<p><strong>Common lesions and tumors:</strong></p><ul><li><strong>Pleomorphic adenoma</strong>: the most common benign salivary tumor overall, usually in the parotid.</li><li><strong>Warthin tumor</strong>: the second most common benign tumor, essentially specific to the parotid.</li><li><strong>Mucoepidermoid carcinoma</strong>: the most common malignant salivary tumor.</li><li><strong>Sialolithiasis</strong>: far more common in the submandibular gland, because its secretion is thicker/more mucous and its duct runs uphill, against gravity, favoring stasis and stone formation.</li></ul>"
      },
      {
        title: "Thyroid & parathyroid anatomy",
        tagline: "Thyroid gland · RLN · Parathyroids",
        html: "<figure class='note-fig' data-credit='Add figure citation'><img class='zoomable' src='assets/img/figures/thyroid_adjacent_structures.png' alt='Thyroid adjacent structures' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Thyroid lobes/isthmus, parathyroid glands, and recurrent laryngeal nerve relationships relevant to thyroidectomy risk.</figcaption></figure>" +
          ...
          "<li>A <strong>pyramidal lobe</strong> projects upward from the isthmus in a substantial minority of people, a remnant of the thyroglossal duct's embryologic descent from the foramen cecum at the tongue base.</li>" +
          "<li>Moves with swallowing because the posterior suspensory <strong>ligament of Berry</strong> anchors it to the cricoid and upper tracheal rings.</li>" +
      ...
      },
      {
        ...
        html: "<figure class='note-fig' data-credit='Add figure citation'><img class='zoomable' src='assets/img/figures/oral_cavity_oropharynx_anatomy.png' alt='Oral cavity oropharynx anatomy' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Anatomic distinction between oral cavity and oropharynx subsites and its oncologic significance (tobacco vs HPV driven cancer).</figcaption></figure>" +
          ...
          "<h4>Oral cavity</h4><ul>" +
          "<li><strong>Boundaries</strong>: skin-vermilion junction of the lips anteriorly &rarr; hard-soft palate junction and circumvallate papillae posteriorly.</li>" +
          "<li><strong>Eight subsites</strong>: mucosal lip, buccal mucosa, floor of mouth, anterior two-thirds (oral) tongue, upper and lower alveolar ridge/gingiva, retromolar trigone, and hard palate.</li>" +
          "<li><strong>Cancer profile</strong>: ~90% squamous cell carcinoma, driven by tobacco and alcohol (synergistic), with betel/areca nut, poor dentition, and chronic trauma as additional factors. Tends to be visible and symptomatic early (a non-healing ulcer, white/red patch, pain), yet up to ~45% have cervical nodal metastases at presentation.</li>" +
          "<li><strong>Lymphatic drainage</strong>: principally to levels I-III, the anterior floor of mouth and lip to submental (Ia)/submandibular (Ib), and the oral tongue to submandibular and upper/mid jugular nodes. The oral tongue can drain bilaterally, which matters for elective neck treatment.</li></ul>" +
          "<h4>Oropharynx</h4><ul>" +
          "<li><strong>Boundaries</strong>: extends from the soft palate superiorly to the level of the hyoid bone (&asymp;C3); continuous with the nasopharynx above, hypopharynx below, and oral cavity in front through the isthmus faucium.</li>" +
          "<li><strong>Four subsites</strong>: base of tongue (posterior third + lingual tonsils), palatine tonsils/tonsillar fossae, soft palate, and posterior pharyngeal wall.</li>" +
          "<li><strong>Cancer profile</strong>: increasingly HPV-associated (most often type 16), arising in the reactive lymphoid tissue of the tonsils and tongue base. Classically a younger, non-smoking patient who presents with a painless cystic neck node rather than local symptoms, the \"asymptomatic primary with a neck mass\" pattern. HPV-driven tumors are staged with a separate AJCC 8th-edition system because of their favorable biology.</li>" +
          "<li><strong>Lymphatic drainage</strong>: to the jugulodigastric (level II) and retropharyngeal nodes; base of tongue and posterior wall drain bilaterally, tonsil tends to drain ipsilaterally first.</li></ul>" +
          "<p><strong>Oral cavity vs HPV+ oropharynx at a glance:</strong></p><div class='tbl-scroll'><table><thead><tr><th>Feature</th><th>Oral cavity</th><th>Oropharynx (HPV+)</th></tr></thead><tbody>" +
          "<tr><td>Main driver</td><td>Tobacco + alcohol (synergistic)</td><td>High-risk HPV, typically type 16</td></tr>" +
          "<tr><td>Typical patient</td><td>Older heavy smoker/drinker</td><td>Younger, often non-smoker</td></tr>" +
          "<tr><td>Usual presentation</td><td>Visible ulcer/patch + pain, early symptoms</td><td>Painless cystic neck node, few local symptoms</td></tr>" +
          "<tr><td>Molecular hallmark</td><td>TP53 mutation</td><td>p16 overexpression (E7-driven)</td></tr>" +
          "<tr><td>Prognosis</td><td>Less favorable</td><td>Substantially better stage-for-stage</td></tr>" +
          "<tr><td>Staging</td><td>Standard AJCC</td><td>Separate AJCC 8th-ed. HPV+ system</td></tr>" +
          "</tbody></table></div>" +
          "<p>The prognostic gap is large: HPV-associated oropharyngeal SCC carries roughly 80-90% 5-year overall survival, versus ~40% for HPV-negative disease.</p>" +
          "<p><strong>High-yield pitfalls:</strong></p><ul>" +
          "<li><strong>p16 testing is for the oropharynx, not the oral cavity</strong>: routine HPV/p16 testing is recommended for oropharyngeal (and sinonasal) tumors, not oral cavity cancers, where it lacks consistent prognostic value.</li>" +
          "<li><strong>A new \"branchial cleft cyst\" in an adult over ~40 is oropharyngeal cancer until proven otherwise</strong>: a cystic level II node from an HPV+ tonsil/base-of-tongue primary can look radiologically and cytologically like a benign branchial cleft cyst; exclude the primary, don't just drain it.</li>" +
          "<li><strong>Smoking still matters even when HPV+</strong>: tobacco use in HPV+ oropharyngeal disease confers an intermediate prognosis, between HPV+ non-smokers (best) and HPV- smokers (worst).</li>" +
          "<li><strong>\"Base of tongue\" is oropharynx, \"oral tongue\" is oral cavity</strong>: the circumvallate papillae are the dividing landmark, and misclassification is a common registry and exam error.</li></ul>"
      }
    ],
    diagrams: [
      {
  ...
  clinical: {
    blocks: [
      ...
      },
      {
        ...
        html: "<ol><li><strong>TSH</strong> first: if low/suppressed, get a radionuclide scan.</li>" +
      ...
      },
      {
        ...
        html: "<p>Bethesda III and IV are the \"indeterminate\" categories (ROM ~22% and ~30%), where cytology alone cannot separate benign from malignant follicular-patterned lesions. Rather than sending every one to diagnostic lobectomy, <strong>molecular testing</strong> on the FNA sample is now standard to refine risk:</p><ul>" +
          ...
          "<li><strong>How they're used:</strong> primarily as <strong>rule-out</strong> tests: all have high negative predictive value (~96-97%), so a benign/negative result supports surveillance instead of surgery, avoiding unnecessary operations. A positive result raises malignancy risk and generally prompts surgery.</li>" +
          ...
          "<p><strong>Common mutations to know:</strong></p><ul>" +
          "<li><strong>BRAF V600E</strong>: the most common driver in papillary thyroid carcinoma; also associated with <strong>radioactive iodine (RAI) resistance</strong>.</li>" +
          "<li><strong>RET</strong>: RET fusions occur in papillary thyroid carcinoma; RET <em>point</em> mutations are the driver in medullary thyroid carcinoma (see pearl below).</li>" +
          "<li><strong>RAS</strong>: seen in follicular-patterned lesions (follicular adenoma, follicular carcinoma, and the follicular variant of papillary carcinoma); tends toward less aggressive behavior.</li></ul>" +
          "<p><strong>Pearl, MEN syndromes and medullary thyroid cancer:</strong> germline <strong>RET proto-oncogene</strong> mutations cause <strong>MEN2A</strong>, <strong>MEN2B</strong>, and familial (hereditary) medullary thyroid carcinoma. Medullary thyroid cancer arises from <strong>parafollicular C-cells</strong>, not follicular cells, and secretes <strong>calcitonin</strong> as a tumor marker.</p>"
      },
      {
        ...
        html: "<p>The historical \"total thyroidectomy for any cancer &gt;1 cm\" paradigm has shifted toward <strong>de-escalation</strong>. Per the 2025 ATA guidelines:</p><ul>" +
          "<li><strong>Lobectomy</strong> is the initial procedure for unifocal, intrathyroidal, node-negative differentiated thyroid cancer <strong>&le;2 cm (cT1N0M0)</strong>: lower complication rates, no lifelong levothyroxine in most patients, equivalent survival.</li>" +
          ...
          "<li><strong>Risk/benefit tradeoff</strong>: total thyroidectomy carries higher rates of recurrent laryngeal nerve injury and hypocalcemia than lobectomy, driving the extent-of-surgery decision.</li></ul>" +
          "<p><strong>Levothyroxine after surgery:</strong></p><ul>" +
          "<li><strong>Total thyroidectomy</strong>: universal, lifelong levothyroxine supplementation.</li>" +
          "<li><strong>Lobectomy</strong>: uncommon; most patients with a healthy remaining lobe stay euthyroid, though a minority eventually need supplementation.</li></ul>"
      },
      {
        id: "salivary-tumours",
        title: "Salivary gland tumors: prevalence and red-flag features",
      ...
      },
      {
        ...
        html: "<p>Approximately 80% of parotid tumors are benign, and approximately 80% of those are pleomorphic adenoma, the two most common parotid entities. A well-rounded differential adds:</p>" +
      ...
      },
      {
        ...
        title: "Hypopharyngeal cancer: prognostic factors and latent presentation",
      ...
      {
        id: "cancer-immunotherapy-intro",
        title: "Cancer immunotherapy: the fundamentals",
        html: "<p>Normally, PD-1 (on T-cells) binding PD-L1 (on tumor or immune cells) switches the T-cell off, letting the tumor evade immune attack. <strong>Checkpoint inhibitors</strong> block that interaction so T-cells can recognize and kill tumor cells. This is the relevant immunotherapy class in head & neck cancer, with <strong>pembrolizumab</strong> and <strong>nivolumab</strong> (anti-PD-1 antibodies) as the drugs to know.</p>" +
          "<p>This is fundamentally different from traditional cytotoxic chemotherapy: chemotherapy kills rapidly dividing cells directly, while checkpoint inhibitors work by releasing the brakes on the patient's own immune system.</p>" +
          "<p><strong>PD-L1 CPS (Combined Positive Score)</strong> quantifies how much PD-L1 the tumor expresses, and it directly guides treatment selection (see KEYNOTE-048, below): higher CPS predicts greater benefit from checkpoint inhibitor monotherapy, while lower CPS tumors generally still need chemotherapy on board.</p>" +
          "<p><strong>Immune-related adverse effects</strong> to know, from unleashing the immune system broadly rather than targeting the tumor alone:</p><ul>" +
          "<li><strong>Colitis</strong> (diarrhea, abdominal pain)</li>" +
          "<li><strong>Pneumonitis</strong> (cough, dyspnea)</li>" +
          "<li><strong>Thyroiditis and other endocrinopathies</strong> (thyroid dysfunction, hypophysitis, adrenal insufficiency)</li>" +
          "<li><strong>Hepatitis</strong> (transaminitis)</li></ul>"
      },
      {
        id: "systemic-therapy-rm",
        title: "First-line systemic therapy: recurrent/metastatic HNSCC",
        html: "<p>The pivotal trial is <strong>KEYNOTE-048</strong>. Two category-1 first-line options for recurrent/metastatic, non-nasopharyngeal HNSCC:</p><ul>" +
          "<li><strong>Pembrolizumab monotherapy</strong>: for PD-L1 <strong>CPS &ge;1</strong> tumors.</li>" +
          "<li><strong>Pembrolizumab + platinum (cisplatin or carboplatin) + 5-FU</strong> (\"chemoimmunotherapy\"): appropriate for any CPS, including CPS &lt;1.</li></ul>" +
          "<p><strong>How CPS guides the choice:</strong></p><ul>" +
          "<li>Greatest monotherapy benefit is in <strong>CPS &ge;20</strong> (median overall survival 14.9 vs 10.7 months vs the older EXTREME regimen).</li>" +
          "<li>In <strong>CPS 1-19</strong>, adding chemotherapy tends to improve disease control.</li>" +
          "<li>Practical pattern: favor <strong>monotherapy for CPS &ge;20</strong>, and <strong>chemoimmunotherapy for lower CPS</strong> or when rapid tumor shrinkage (high disease burden) is needed.</li></ul>" +
          "<p>The older <strong>EXTREME regimen</strong> (platinum/5-FU + cetuximab) remains an alternative when checkpoint inhibition isn't appropriate.</p>"
      },
      {
        id: "systemic-therapy-npc",
        title: "First-line systemic therapy: nasopharyngeal carcinoma (NPC)",
        html: "<p>NPC is handled separately from other HNSCC because of its distinct EBV-driven biology and radiosensitivity. First-line systemic therapy for recurrent/metastatic NPC is <strong>cisplatin/gemcitabine plus a PD-1 inhibitor</strong> (e.g., toripalimab).</p>"
      },
      {
        id: "free-flap-fundamentals",
        title: "Free flap reconstruction: the fundamentals",
        html: "<p>A <strong>free flap</strong> (free tissue transfer) is a block of tissue harvested with its own artery and vein from a distant donor site, disconnected completely, then microvascularly re-anastomosed to recipient vessels in the neck. Unlike a graft, a flap brings its own blood supply, so it survives independent of the wound bed's vascularity, critical in irradiated or poorly vascularized fields.</p>" +
          "<p><strong>Three tiers of the reconstructive ladder</strong>, in ascending complexity:</p><ul>" +
          "<li><strong>Local flap</strong>: adjacent tissue repositioned into the defect.</li>" +
          "<li><strong>Regional/pedicled flap</strong>: tissue rotated on an intact vascular pedicle (e.g., pectoralis major myocutaneous flap), limited by pedicle length/arc of rotation.</li>" +
          "<li><strong>Free flap</strong>: microvascular transfer from a distant site, freeing the surgeon from arc-of-rotation constraints.</li></ul>" +
          "<p>Microvascular free tissue transfer is now the accepted standard of care for reconstructing complex head and neck defects after tumor ablation.</p>" +
          "<p><strong>Oncologic Rationale for Free Flap Reconstruction</strong></p><ul>" +
          "<li><strong>Reliable primary healing in irradiated tissue</strong>: protects against wound breakdown, fistula, and osteoradionecrosis in patients needing adjuvant chemoradiotherapy.</li>" +
          "<li><strong>Enables radical resection</strong>: the surgeon should never compromise tumor-free margins for an easier closure.</li>" +
          "<li><strong>Two-team approach</strong>: ablative and reconstructive teams work simultaneously, shortening operative time.</li>" +
          "<li><strong>Long-term stability</strong>: revascularized bone flaps resist resorption and maintain contour.</li></ul>" +
          "<p><strong>How the flap is chosen, a matching exercise:</strong></p><ul>" +
          "<li><strong>Tissue composition needed</strong>: soft tissue only/fasciocutaneous, bulk/myocutaneous, or bone/osteocutaneous (composite/chimeric flaps combine bone and soft tissue on separate branches).</li>" +
          "<li><strong>Thinness/pliability</strong>: the tongue and floor of mouth need thin, pliable tissue; a bulky flap impairs function.</li>" +
          "<li><strong>Pedicle length and vessel caliber</strong>: must reach recipient neck vessels and match for anastomosis.</li>" +
          "<li><strong>Donor-site morbidity</strong>.</li>" +
          "<li><strong>Patient factors</strong>: body habitus, peripheral vascular disease affecting fibula candidacy, prior surgery, comorbidities.</li></ul>" +
          "<p>The anterolateral thigh, radial forearm, and fibula are the \"workhorse\" flaps, covering the large majority of reconstructions.</p>"
      },
      {
        id: "free-flap-soft-tissue-workhorses",
        title: "Workhorse soft-tissue free flaps",
        html: "<p>Fasciocutaneous and myocutaneous options for soft-tissue defects.</p>",
        table: {
          head: ["Flap", "Donor site", "Pedicle vessel", "Tissue type", "Ideal defect / must-know point"],
          rows: [
      ...
      {
        id: "free-flap-osseous",
        title: "Osseous (bone-containing) free flaps",
        html: "<p>For mandible/maxilla defects, the gold standard for restoring continuity, occlusion, and a platform for dental implants.</p>",
        table: {
          head: ["Flap", "Donor site", "Pedicle vessel", "Must-know point"],
          rows: [
      ...
      {
        id: "free-flap-perioperative",
        title: "Free flap perioperative principles (ERAS pathway)",
        html: "<ul><li><strong>Fluid management</strong>: avoid overload and under-resuscitation; aim for near-zero balance/goal-directed therapy.</li>" +
          "<li><strong>Vasopressors</strong> are not contraindicated intraoperatively.</li>" +
          "<li><strong>Restrictive transfusion</strong>: transfusion doesn't improve flap survival and is associated with more complications.</li>" +
          "<li><strong>Nutrition and multimodal, opioid-sparing analgesia</strong>.</li>" +
          "<li><strong>Flap monitoring</strong>: serial clinical checks (color, capillary refill, temperature, Doppler); the first 48-72 hours are highest risk for anastomotic thrombosis, and early recognition enables salvage.</li></ul>"
      },
      {
        id: "free-flap-complications",
        title: "Free flap complications and outcomes",
        html: "<ul><li>Overall success rates exceed <strong>~95%</strong> at experienced centers; pooled data show flap compromise in <strong>~8%</strong> and complete flap failure in <strong>~4%</strong>.</li>" +
          "<li>The most common cause of flap loss is <strong>arterial or venous thrombosis</strong> at the anastomosis; venous congestion is more common and often more salvageable if caught early.</li>" +
          "<li><strong>Risk factors, non-modifiable</strong>: prior radiotherapy is strongest, plus diabetes and advanced age.</li>" +
          "<li><strong>Risk factors, modifiable/intraoperative</strong>: prolonged ischemia time, fluid overload, low albumin, need for intraoperative pedicle revision, postoperative alcohol withdrawal.</li>" +
          "<li><strong>Donor-site-specific morbidity</strong>: RFFF (tendon exposure/graft needs), fibula (gait/ankle issues, needs vascular runoff), latissimus (shoulder weakness).</li>" +
          "<li>The feared late complication is <strong>carotid blowout</strong>, from wound breakdown/infection eroding neck vessels, the rationale for well-vascularized flap coverage over the carotid.</li></ul>"
      }
    ],
    redFlags: [
  ...
  cases: [
    ...
    },
    {
      ...
      teaching: "<figure class='note-fig' data-credit='Add figure citation'><img class='zoomable' src='assets/img/figures/parotid_facial_nerve.png' alt='Parotid facial nerve' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Enlarging parotid mass with new facial weakness signifying likely malignant nerve invasion.</figcaption></figure>A parotid mass is a low-stakes finding until the facial nerve is involved. Then it's a different conversation entirely."
    },
    {
  ...
  cards: [
    ...
    { id:"parotid-rule-80s-card", tags: ["HN", "clinical"], milestones:["PC3","MK3"], ukmla:"Facial/periorbital swelling", source:"Standard head & neck oncology teaching on parotid tumor prevalence.", front:"What proportion of parotid tumors are benign, what is the most common benign entity, and what is the most common malignant one?",
      back:"~<strong>80%</strong> of parotid tumors are <strong>benign</strong>, and ~<strong>80%</strong> of those benign tumors are <strong>pleomorphic adenoma</strong> (the most common salivary neoplasm overall). The most common <em>malignant</em> parotid tumor is <strong>mucoepidermoid carcinoma</strong>.<figure class='note-fig' data-credit='Add figure citation'><img class='zoomable' src='assets/img/figures/parotid_pathology.png' alt='Parotid pathology' loading='lazy' tabindex='0' role='button' aria-label='Enlarge figure'><figcaption>Parotid tumor prevalence: pleomorphic adenoma most common benign, mucoepidermoid carcinoma most common malignant.</figcaption></figure>" },
    ...
    { id:"free-flap-workhorse-pedicles-card", tags: ["HN", "clinical"], milestones:["PC3","PC8"], scope:"sub-I", ukmla:"Neck lump", source:"Standard head & neck reconstructive surgery teaching.", front:"Name the pedicle vessel for the three workhorse free flaps: RFFF, ALT, and fibula.",
      back:"<strong>Radial forearm free flap (RFFF)</strong> &rarr; <strong>radial artery</strong>. <strong>Anterolateral thigh (ALT)</strong> &rarr; <strong>descending branch of the lateral circumflex femoral artery</strong>. <strong>Fibula</strong> &rarr; <strong>peroneal artery</strong>." },
    { id:"free-flap-osseous-choice-card", tags: ["HN", "clinical"], milestones:["PC3","PC8"], scope:"sub-I", ukmla:"Neck lump", source:"Standard head & neck reconstructive surgery teaching.", front:"A defect that includes bone loss calls for what class of flap, and which one is the mandibular workhorse?",
      back:"A bone defect calls for an <strong>osseous (bone-containing) flap</strong>. The <strong>fibula</strong> is the workhorse for mandibular reconstruction because its long bone stock tolerates multiple osteotomies and accepts <strong>dental implants</strong>." },
    { id:"free-flap-vs-graft-card", tags: ["HN", "clinical"], milestones:["PC3","PC8"], scope:"sub-I", ukmla:"Neck lump", source:"Standard head & neck reconstructive surgery teaching.", front:"Why does a free flap survive in an irradiated wound bed when a skin graft would fail?",
    ...
    { id:"free-flap-fibula-runoff-card", tags: ["HN", "clinical"], milestones:["PC3","PC8"], scope:"sub-I", redFlag:true, ukmla:"Neck lump", source:"Standard head & neck reconstructive surgery teaching.", front:"What must be checked before harvesting a fibula free flap?",
      back:"<strong>Adequate lower-limb arterial runoff</strong> (three-vessel leg circulation), to avoid harvesting the leg's dominant blood supply and compromising the foot." },
    { id:"free-flap-monitoring-window-card", tags: ["HN", "clinical"], milestones:["PC3","PC8"], scope:"sub-I", redFlag:true, ukmla:"Neck lump", source:"Standard head & neck reconstructive surgery teaching.", front:"When is a free flap at highest risk of failure, and what's the classic early salvageable finding?",
      back:"The first <strong>48-72 hours</strong> after surgery, from anastomotic thrombosis. <strong>Venous congestion</strong> is the classic early finding and is often salvageable if caught quickly; arterial thrombosis is less common but less forgiving." },
    { id:"free-flap-risk-factor-card", tags: ["HN", "clinical"], milestones:["PC3","PC8"], scope:"sub-I", ukmla:"Neck lump", source:"Standard head & neck reconstructive surgery teaching.", front:"What is the single biggest patient risk factor for free flap failure?",
      back:"<strong>Prior radiotherapy</strong> to the surgical field, the strongest non-modifiable risk factor, ahead of diabetes and advanced age." },
