    ...
    notes: [
      {
        ...
        tagline: "The Robbins nodal-level map every neck exam and cancer staging discussion is built on.",
      ...
      },
      {
        ...
        tagline: "Parotid vs submandibular anatomy -- why facial-nerve function is documented around parotid surgery, and where stones form.",
      ...
      },
      {
        ...
        tagline: "Why thyroidectomy risks the voice (RLN) and calcium (parathyroids) in the same operation.",
      ...
      },
      {
        ...
        tagline: "The subsite boundary that splits tobacco-driven oral cavity cancer from increasingly HPV-driven oropharyngeal cancer.",
